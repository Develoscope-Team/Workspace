...
<body   id="kt_header" class="header flex-column header-fixed">
						<!--begin::Top-->
								...
								<ul class="header-tabs nav flex-column-auto" role="tablist">
									...
									<li class="nav-item">
										<a href="#" class="nav-link" data-toggle="tab" data-target="#kt_header_tab_2" role="tab">
											...
											<span class="nav-desc">Corporate Finance &amp; Audit</span>
										</a>
									</li>
									<!--end::Item-->
									<!--begin::Item-->
									<li class="nav-item">
										<a href="#" class="nav-link" data-toggle="tab" data-target="#kt_header_tab_2" role="tab">
											...
											<span class="nav-desc">Tools &amp; Metrics</span>
										</a>
									</li>
									<!--end::Item-->
									<!--begin::Item-->
									<li class="nav-item">
										<a href="#" class="nav-link" data-toggle="tab" data-target="#kt_header_tab_2" role="tab">
											<span class="nav-title text-uppercase">Orders</span>
											<span class="nav-desc">Order Management</span>
										</a>
									</li>
									<!--end::Item-->
									<!--begin::Item-->
									<li class="nav-item">
										<a href="#" class="nav-link" data-toggle="tab" data-target="#kt_header_tab_2" role="tab">
											<span class="nav-title text-uppercase">Customers</span>
											<span class="nav-desc">CRM &amp; Support</span>
										</a>
									</li>
									<!--end::Item-->
								</ul>
...
<script>var HOST_URL = "https://preview.keenthemes.com/metronic/theme/html/tools/preview";</script>
		...
		<script src="<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/ipd-opd/plugins/global/plugins.bundle.js"></script>
		<script src="<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/ipd-opd/plugins/custom/prismjs/prismjs.bundle.js"></script>
		<script src="<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/ipd-opd/js/scripts.bundle.js"></script>
		<!--end::Global Theme Bundle-->
		<!--begin::Page Vendors(used by this page)-->
		<script src="<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/ipd-opd/plugins/custom/fullcalendar/fullcalendar.bundle.js"></script>
		<!--end::Page Vendors-->
		<!--begin::Page Scripts(used by this page)-->
		<script src="<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/ipd-opd/js/pages/widgets.js"></script>
