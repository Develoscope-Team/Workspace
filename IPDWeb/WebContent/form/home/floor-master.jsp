													...
													<div class="form-group">
														<label>Floor Number :</label> <input type="text"
															...
															<div class="text-center">
																<button type="button" id="addFloor"
																	class="btn btn-primary mr-2" >Submit</button>
																<button type="submit" id="updateFloor"
	...
	$("#addFloor").show();
		...
		$('#addFloor').click(function() {
						...
						if(building_name != "" && floor_number != ""){
							$.ajax({
								// http://localhost:8080/ipdAPI/ipdapi/insertUpdateFloor
								url : base +"/ipdAPI/ipdapi/insertUpdateFloor",
								...
								success : function(response) {
									if (response != null) {
										...
										if (response >= 1) {
											...
											var msg = "Floor Data inserted Successfully.";
											alert(msg);
...
$.ajax({
	...
	url : base +"/ipdAPI/ipdapi/getFloor",
		 ...
		 function update(id){
				...
				$.ajax({
			        ...
			        success:function(data)
			        {
			            ...
			            const row = data.find(d => d.floor_id ==id);
			           
			            $("#building_name").val(row.building_name);
			        	$("#floor_number").val(row.floor_number);
										...
										success : function(response) {
											if (response != null) {
												...
												if (response >= 1) {
													...
													var msg = "Floor Data updated Successfully.";
													alert(msg);
				...
				success : function(response) {
					if (response != null) {
						...
						if (response >=1) {
							...
							var msg = "Floor Data deleted Successfully.";
							alert(msg);
