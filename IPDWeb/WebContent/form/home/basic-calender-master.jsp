...
<script type="text/javascript">
	...
	$("#addCalender").show();
		...
		$('#addCalender').click(function() {
							...
							var date = $('#date').val();
							var add_event = $('#add_event').val();
							var flag = 1; // Addition

						if(date != "" && add_event != ""){
							$.ajax({
								// http://localhost:8080/ipdAPI/ipdapi/insertUpdateCalender
								url : base +"/ipdAPI/ipdapi/insertUpdateCalender",
								...
								success : function(response) {
									if (response != null) {
										...
										if (response >= 1) {
											...
											var msg = "Calender Data inserted Successfully.";
											alert(msg);
		 ...
		 function update(id){
				...
				$.ajax({
			        ...
			        success:function(data)
			        {
			            ...
			            const row = data.find(d => d.calender_id ==id);
			           
			            $("#date").val(row.date);
			        	$("#add_event").val(row.add_event);
										...
										success : function(response) {
											if (response != null) {
												...
												if (response >= 1) {
													...
													var msg = "Calender Data updated Successfully.";
													alert(msg);
				...
				success : function(response) {
					if (response != null) {
						...
						if (response >=1) {
							...
							var msg = "Calender Data deleted Successfully.";
							alert(msg);
