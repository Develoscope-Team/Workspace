...
<body id="kt_body"
	...
	<div id="kt_header_mobile" class="header-mobile header-mobile-fixed">
		<!--begin::Logo-->
		<a href="index.html" class="mr-20"> <img alt="Logo"
			src="<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/ipd-opd/media/logos/LogoFinal.png"
			class="max-h-70px" />
		</a>
		<!--end::Logo-->
		<!--begin::Toolbar-->
		<div class="d-flex align-items-center">
			...
			<button class="btn btn-icon p-0 ml-4"
				id="kt_header_mobile_topbar_toggle">
				<span class="svg-icon svg-icon-xxl"> <!--begin::Svg Icon | path:assets/media/svg/icons/General/User.svg-->
	...
	<div class="d-flex flex-row flex-column-fluid container">
		...
		<div class="main d-flex flex-column flex-row-fluid">
			<div class="content flex-column-fluid" id="kt_content">
				...
				<h2
					class="d-flex align-items-center text-dark font-weight-bold my-1 mr-3">Global Notice
					Master</h2>
							...
							<div class="card card-custom">
								<form class="form" id="kt_form_1">
												...
												<div class="col-xl-6">
													<div class="form-group">
														<label>Notice Name :</label> <input type="text"
															id="notice_name" class="form-control form-control-solid"
									...
									<div class="text-center">
										<button type="button" id="addglobal_notice"
											class="btn btn-primary mr-2"
											>Submit</button>
										<button type="submit" id="updateglobal_notice"
										class="btn btn-primary mr-2"
											>Update</button>
				...
				<div class="card card-custom ">
					<br/>
						<div class="input-icon ml-10" style="width: 40%;">
							...
							<thead>
								<tr>
									...
									<th class="col-sm-3 text-center"
										data-field="notice-description" data-sortable="true">Notice
										decription</th>
	...
	<div id="kt_quick_notifications" class="offcanvas offcanvas-right p-10">
		...
		<div
			...
			<h3 class="font-weight-bold m-0">
				Notifications <small class="text-muted font-size-sm ml-2">24
					New</small>
			</h3>
				...
				<div
					...
					<div class="d-flex flex-column flex-grow-1 mr-2">
						<a href="#"
							...
							be to people</a> <span class="text-muted font-size-sm">Due in
							2 Days</span>
					</div>
				...
				<div class="d-flex align-items-center bg-light-info rounded p-5">
					...
					<div class="d-flex flex-column flex-grow-1 mr-2">
						<a href="#"
							...
							best product</a> <span class="text-muted font-size-sm">Due in
							2 Days</span>
					</div>
	...
	<ul class="sticky-toolbar nav flex-column pl-2 pr-2 pt-3 pb-3 mt-4">
		...
		<li class="nav-item mb-2" data-toggle="tooltip" title="Layout Builder"
			...
			href="https://preview.keenthemes.com/metronic/demo11/builder.html"
