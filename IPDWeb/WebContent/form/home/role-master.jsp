...
<body id="kt_body"
	...
	class="quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled page-loading">
		...
		class="container">
				...
				<h2 class="text-gray font-weight-bold my-2 mr-5">Role Master</h2>
										...
										<div class="card-body">
											<div class="example mb-10">
												<div class="example-preview">
													...
													<div class="form-group">
														<label>Access List :</label> <input type="text"
															id="access_list" class="form-control form-control-solid"
															placeholder="Enter Access List" />
															<span class="form-text text-muted">Please Enter Access List.</span>
													</div>
										...
										<table data-toggle="table" class='a'
											...
											<thead>
												<tr>
													...
													<th class="col-sm-3 text-center" data-field="access-list"
														data-sortable="true">Access List</th>
...
<script type="text/javascript">
	...
	$("#addRole").show();
		...
		$('#addRole').click(function() {
							...
							var access_list = $('#access_list').val();
							var flag = 1; // Addition

						if(room_name != "" && access_list != ""){
							$.ajax({
								// http://localhost:8080/ipdAPI/ipdapi/insertUpdateRole
								url : base +"/ipdAPI/ipdapi/insertUpdateRole",
...
$.ajax({
	...
	url : base +"/ipdAPI/ipdapi/getRole",
		 ...
		 function update(id){
				...
				$.ajax({
			        ...
			        success:function(data)
			        {
			        	...
			        	$("#access_list").val(row.access_list);
