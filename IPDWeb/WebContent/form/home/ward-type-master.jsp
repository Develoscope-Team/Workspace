...
<body id="kt_body"
	...
	class="quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled page-loading">
		...
		class="container">
				...
				<h2 class="text-gray font-weight-bold my-2 mr-5">Ward Type Master</h2>
...
<script type="text/javascript">
	...
	$("#addWardtype").show();
		...
		$('#addWardtype').click(function() {
						...
						if(ward_type != ""){
							$.ajax({
								// http://localhost:8080/ipdAPI/ipdapi/insertUpdateWardtype
								url : base +"/ipdAPI/ipdapi/insertUpdateWardtype",
								...
								success : function(response) {
									if (response != null) {
										...
										if (response >= 1) {
											...
											var msg = "Wardtype Data inserted Successfully.";
											alert(msg);
		 ...
		 function update(id){
				...
				$.ajax({
			        ...
			        success:function(data)
			        {
			            ...
			            const row = data.find(d => d.wardtype_id ==id);
										...
										success : function(response) {
											if (response != null) {
												...
												if (response >= 1) {
													...
													var msg = "Wardtype Data updated Successfully.";
													alert(msg);
				...
				success : function(response) {
					if (response != null) {
						...
						if (response >=1) {
							...
							var msg = "Wardtype Data deleted Successfully.";
							alert(msg);
