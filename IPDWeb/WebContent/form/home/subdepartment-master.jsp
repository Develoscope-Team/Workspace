											...
											<div class="example mb-10">
												...
												<div class="form-group">
															...
															<div class="text-center">
																<button type="button" id="addSubdepartment"
																	class="btn btn-primary mr-2" >Submit</button>
																<button type="submit" id="updateSubdepartment" 
...
<script type="text/javascript">
	...
	$('#updateSubdepartment').hide();
	$("#addSubdepartment").show();
		...
		$('#addSubdepartment').click(function() {
						...
						if(department_name != ""){
							$.ajax({
								// http://localhost:8080/ipdAPI/ipdapi/insertUpdateSubdepartment
								url : base +"/ipdAPI/ipdapi/insertUpdateSubdepartment",
								...
								success : function(response) {
									if (response != null) {
										...
										if (response >= 1) {
											...
											var msg = "Subdepartment Data inserted Successfully.";
											alert(msg);
...
$.ajax({
	...
	url : base +"/ipdAPI/ipdapi/getSubdepartment",
...
$(document).ready(function (){
	   var table = $('#table-id').DataTable();
		 ...
		 function update(id){
				...
				$('.btn_subdepartment').hide();
				

				
				$('#updateSubdepartment').show();
				$("#addSubdepartment").hide();
				...
				$.ajax({
			        ...
			        success:function(data)
			        {
			            ...
			            const row = data.find(d => d.subdepartment_id ==id);
										...
										success : function(response) {
											if (response != null) {
												...
												if (response >= 1) {
													...
													var msg = "Subdepartment Data updated Successfully.";
													alert(msg);
				...
				success : function(response) {
					if (response != null) {
						...
						if (response >=1) {
							...
							var msg = "Subdepatment Data deleted Successfully.";
							alert(msg);
