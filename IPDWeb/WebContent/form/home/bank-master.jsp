											...
											<div class="row">
												<div class="col-xl-6">
													<div class="form-group">
														<label>Bank Name</label> <input type="text" id="bank_name"
												...
												<div class="col-xl-6">
													<div class="form-group">
														<label>Account Type</label> <select
															class="form-control form-control-solid" name="account"
															id="acc_type">
												...
												<div class="col-xl-6">
													<div class="form-group">
														<label>Account No </label> <input type="text"
															id="account_no" class="form-control form-control-solid"
															placeholder="Enter Account No." />
													</div>
												</div>
												<div class="col-xl-6">
													<div class="form-group">
														<label>IFSC Code</label> <input type="text" id="IFSC_code"
															class="form-control form-control-solid"
