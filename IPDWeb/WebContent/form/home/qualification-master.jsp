...
<body id="kt_body"
	...
	class="quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled page-loading">
		...
		class="container">
				...
				<h2 class="text-gray font-weight-bold my-2 mr-5">Qualification Master</h2>
														...
														<form class="form" id="kt_form_1">
															<div class="card-body">
																<div class="form-group">
																	<label>Qualification Name :</label><span class="text-danger"
																		id="type">*</span> <input type="text" name="qualification_name"
																		id="qualification_name" class="form-control form-control-solid"
																		placeholder="Enter Qualification Name" required /> <span
																		class="msg text-danger" id="type1"> </span>
																		<span class="form-text text-muted">Please Enter Qualification Name.</span>
																</div>
															</div>
															<div class="text-center">
																<button type="button" id="addQualification"
																	class="btn btn-primary mr-2" style="background-color: #AB48FF; ">Submit</button>
														        <button type="submit" id="updateQualification" 
										...
										<table data-toggle="table" class='a'
											...
											<thead>
												<tr>
													...
													<th class="col-sm-3 text-center" data-field="qualification-name"
														data-sortable="true">Qualification Name</th>
	...
	$("#addQualification").show();
		...
		$('#addQualification').click(function() {
						...
						if(qualification_name != ""){
							$.ajax({
								// http://localhost:8080/ipdAPI/ipdapi/insertUpdateQualification
								url : base +"/ipdAPI/ipdapi/insertUpdateQualification",
								...
								success : function(response) {
									if (response != null) {
										...
										if (response >= 1) {
											...
											var msg = "Qualification Data inserted Successfully.";
											alert(msg);
...
$.ajax({
	...
	url : base +"/ipdAPI/ipdapi/getQualification",
...
$(document).ready(function (){
		 ...
		 function update(id){
				...
				$.ajax({
			        ...
			        success:function(data)
			        {
			            ...
			            const row = data.find(d => d.qualification_id ==id);
			           
			            $("#qualification_name").val(row.qualification_name);
	...
	"use strict";
		...
		// Delete data by qualification_id
