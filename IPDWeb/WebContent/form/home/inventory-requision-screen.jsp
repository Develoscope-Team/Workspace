...
<body id="kt_body"
	...
	<div class="container">
		 ...
		 <h2
								class="d-flex align-items-center text-gray font-weight-bold my-1 mr-3">Inventory Requision Screen</h2> 
								...
								<form class="form" id="kt_form_1">
									...
									<div class="text-center">
										<button type="button" id="addProduct"
											class="btn btn-primary mr-2" style="background-color: #AB48FF; ">Request</button>

										<button type="button" class="btn btn-primary mr-2" style="background-color: #AB48FF; "id="cancel">Revoke Request</button>
									</div>
								</form>
