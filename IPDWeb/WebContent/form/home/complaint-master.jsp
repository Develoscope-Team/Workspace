									...
									<form class="form" id="kt_form_1">
										<div class="card-body">
											...
											<div class="form-group">
												<label>Complaint Name :</label> <input type="text"
													id="complaint_name" class="form-control form-control-solid"
													placeholder="Enter Complaint Name" />
											</div>


											<div class="form-group">
												<label>Complaint Details :</label> <input type="text"
				...
				<div class="card card-custom gutter-b">
					<div class="card-body">
						...
						<table data-toggle="table" class='a'
							...
							data-scroll="false" data-height=280 id="table-id">
							<thead>
								<tr>
									<th class="col-sm-3 text-center" data-field="sr-no"
										data-sortable="true">Sr No</th>
									<th class="col-sm-3 text-center" data-field="complaint_name"
										data-sortable="true">Complaint Name</th>
									<th class="col-sm-3 text-center" data-field="complaint_detail"
										data-sortable="true">Complaint Detail</th>
...
<script type="text/javascript">
	...
	$("#addcomplaint").show();
		...
		$('#adduser').click(function() {
							...
							varcomplaint_desc = $('#complaint_detail').val();
							
							var flag = 1; // Addition

						if(complaint_name != "" ){
							$.ajax({
								// http://localhost:8080/ipdAPI/ipdapi/insertUpdatecomplaint
								url : base +"/ipdAPI/ipdapi/insertUpdatecomplaint",
								...
								success : function(response) {
									if (response != null) {
										...
										if (response >= 1) {
											...
											var msg = "complaint Data inserted Successfully.";
											alert(msg);
...
$.ajax({
	...
	url : base +"/ipdAPI/ipdapi/getcomplaint",
		 ...
		 function update(id){
				...
				$.ajax({
			        ...
			        success:function(data)
			        {
			            ...
			            const row = data.find(d => d.complaint_id ==id);
			           
			            $("#complaint_name").val(row.complaint_name);
			        	$("#complaint_detail").val(row.complaint_detail);
				...
				.click(
						function() {
							...
							var complaint_name = $('#complaint_name').val();
							var complaint_detail= $('#complaint_detail').val();
										...
										success : function(response) {
											if (response != null) {
												...
												if (response >= 1) {
													...
													var msg = "Complaint Data updated Successfully.";
													alert(msg);
				...
				success : function(response) {
					if (response != null) {
						...
						if (response >=1) {
							...
							var msg = "Complaint Data deleted Successfully.";
							alert(msg);
