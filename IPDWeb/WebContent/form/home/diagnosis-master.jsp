										...
										<div class="card-body">
											<div class="form-group">
												<label>Diagnosis Name :</label><span class="text-danger"
													id="type"></span> <input type="text" name="diagnosis_name"
													id="diagnosis_name" class="form-control form-control-solid"
													placeholder="Enter Diagnosis Name" required />
											</div>
											<div class="form-group">
												<label>Diagnosis Detail :</label><span class="text-danger"
													id="type"></span> <input type="text"
													name="diagnosis_detail" id="diagnosis_detail"
													class="form-control form-control-solid"
													placeholder="Enter Diagnosis Detail" required />
											</div>
										</div>
						...
						<table data-toggle="table" class='a'
							...
							<thead>
								<tr>
									...
									<th class="col-sm-3 text-center" data-field="diagnosis_name"
										data-sortable="true">Diagnosis Name</th>
									<th class="col-sm-3 text-center" data-field="diagnosis_desc"
										data-sortable="true">Diagnosis Detail</th>
...
<script type="text/javascript">
	...
	$("#adddiagnosis").show();
		...
		$('#adddiagnosis').click(function() {
							...
							var diagnosis_detail = $('#diagnosis_detail').val();
							
							var flag = 1; // Addition

						if(diagnosis_name != "" ){
							$.ajax({
								// http://localhost:8080/ipdAPI/ipdapi/insertUpdatediagnosis
								url : base +"/ipdAPI/ipdapi/insertUpdatediagnosis",
...
$.ajax({
	...
	url : base +"/ipdAPI/ipdapi/getdiagnosis",
		 ...
		 function update(id){
				...
				$.ajax({
			        ...
			        success:function(data)
			        {
			            ...
			            $("#diagnosis_name").val(row.dianosis_name);
			        	$("#diagnosis_detail").val(row.diagnosis_detail);
				...
				.click(
						function() {
							...
							var gianosis_name = $('#dianosis_name').val();
							var diagnosis_detail = $('#diagnosis_detail').val();
