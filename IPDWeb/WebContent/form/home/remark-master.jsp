...
<script type="text/javascript">
	...
	$("#addremark").show();
		...
		$('#addremark').click(function() {
						...
						if(remark_name != "" ){
							$.ajax({
								// http://localhost:8080/ipdAPI/ipdapi/insertUpdateremark
								url : base +"/ipdAPI/ipdapi/insertUpdateremark",
...
$.ajax({
	...
	url : base +"/ipdAPI/ipdapi/getremark",
