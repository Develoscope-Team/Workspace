	...
	<!--begin::Main-->
					...
					<div class="d-flex flex-row flex-column-fluid container">
						...
						<div class="main d-flex flex-column flex-row-fluid">
							...
							<h2
								class="d-flex align-items-center text-dark font-weight-bold my-1 ml-5">Ambulance Master</h2>
											...
											<div class="card card-custom">
												<form class="form" id="kt_form_1">
													  ...
													  <div class="col-xl-6">
													    <div class="form-group">
															<label>Ambulance No :</label> <input type="text"
																name="ambulance_no" id="ambulance_no"
													...
													<div class="row">
													    <div class="col-xl-6">	
													     <div class="form-group">
														    <label>Ambulance Price :</label><input type="text" 
														         name="ambulance_price" id="ambulance_price"
														         class="form-control form-control-solid"
														         placeholder="Enter Ambulance Price" />
														 </div>
														</div>
													   <div class="col-xl-6">
														<div class="form-group">
													...
													<div class="text-center">
														<button type="submit" id="addambulance"
											...
											<table data-toggle="table" class='a'
												...
												<thead>
													<tr>
														...
														<th class="col-sm-2 text-center" data-field="ambulance-purchase-date"
															data-sortable="true">Ambulance Purchase Date</th>
														<th class="col-sm-2 text-center" data-field="ambulance-price"
														    data-sortable="true">Ambulance Price</th>
	...
	$("#addambulance").show();
		...
		$('#addambulance').click(function() {
			               ...
			               var flag = 1; // Addition
							...
							var ambulance_price = $('#ambulance_price').val();
						
							

						if(ambulance_no != "" && ambulance_purchase_date != ""){
							
							alert(ambulance_no);alert(ambulance_purchase_date);alert(ambulance_price);alert(purchase_place);
							
							
							alert(flag);
							$.ajax({
								url : " http://localhost:8080/ipdAPI/ipdapi/insertUpdateambulance",
								type : "post",
								dataType : "json",
								async : false,
								data : {
									...
									"ambulance_price"         : ambulance_price,
...
$.ajax({
	...
	success:function(data)
	{
		...
		data.forEach((row)=> {
			           ...
			           html += "<td>"+row.ambulance_price+"</td>";
	...
	function update(id){
				...
				$.ajax({
			        ...
			        success:function(data)
			        {
			            ...
			            $("#ambulance_price").val(row.ambulance_price);
