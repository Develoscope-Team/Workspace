...
<body id="kt_body"
	...
	class="quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled page-loading">
		...
		class="container">
				...
				<h2 class="text-gray font-weight-bold my-2 mr-5">Clinical Notes Master</h2>
													...
													<div class="form-group">
														<label>Clinical Notes :</label><input type="text"
															...
															<div class="text-center">
																<button type="button" id="addClinicalnotes"
																	class="btn btn-primary mr-2" style="background-color: #AB48FF; ">Submit</button>
															<button type="submit" id="updateClinicalnotes"
										...
										<table data-toggle="table" class='a'
											...
											<thead>
												<tr>
													...
													<th class="col-sm-3 text-center" data-field="clinical-notes"
														data-sortable="true">Clinical Notes </th>
...
<script type="text/javascript">
	...
	$('#updateClinicalnotes').hide();
	$("#addClinicalnotes").show();
		...
		$('#addClinicalnotes').click(function() {
						...
						if(clinical_notes != ""){
							$.ajax({
								// http://localhost:8080/ipdAPI/ipdapi/insertUpdateClinicalnotes
								url : base +"/ipdAPI/ipdapi/insertUpdateClinicalnotes",
								...
								success : function(response) {
									if (response != null) {
										...
										if (response >= 1) {
											...
											var msg = "Clinicalnotes Data inserted Successfully.";
											alert(msg);
...
$(document).ready(function (){
	   var table = $('#table-id').DataTable();
		 ...
		 function update(id){
				...
				$('.btn_clinicalnotes').hide();
				

				
				$('#updateClinicalnotes').show();
				$("#addClinicalnotes").hide();
				
				$.ajax({
			        type:"POST",
			        dataType: "json",
			        data:{"clinicalnotes_id": id},
					async : false,
					url : base +"/ipdAPI/ipdapi/getClinicalnotes",
			        success:function(data)
			        {
			        	
			            const row = data.find(d => d.clinicalnotes_id ==id);
			           
			            $("#clinical_notes").val(row.clinical_notes);
			        }
			     });
										...
										success : function(response) {
											if (response != null) {
												...
												if (response >= 1) {
													...
													var msg = "Clinicalnotes Data updated Successfully.";
													alert(msg);
				...
				success : function(response) {
					if (response != null) {
						...
						if (response >=1) {
							...
							var msg = "Clinicalnotes Data deleted Successfully.";
							alert(msg);
