...
<script src="https://code.jquery.com/jquery-3.4.1.js"></script>
	...
	<!--begin::Body-->
	<body id="kt_body" style="background-image: url(<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/ipd-opd/media/bg/bg-9.jpg)"
	...
	<!--begin::Main-->
					...
					<div id="kt_header_mobile" class="header-mobile header-mobile-fixed">
						...
						<a href="index.html" class="mr-20">
									<img alt="Logo"
										src="<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/ipd-opd/media/logos/LogoFinal.png" class="max-h-70px" />
									</a>
						<!--end::Logo-->
						<!--begin::Toolbar-->
					...
					<div class="d-flex flex-row flex-column-fluid container">
						...
						<div class="main d-flex flex-column flex-row-fluid">
							...
							<h2
								class="d-flex align-items-center text-dark font-weight-bold my-1 ml-5">Asset Master</h2>
											...
											<div class="card card-custom">
												<form class="form" id="kt_form_1">
													...
													<div class="row">
													    <div class="col-xl-6">	
													     <div class="form-group">
														    <label>Asset Price :</label><input type="text"
														        name="asset_price" id="asset_price" 
														        class="form-control form-control-solid"
													   ...
													   <div class="col-xl-6">
														<div class="form-group">
														   <label>Asset Amount :</label><input type="text"
														       name="asset_amount" id="asset_amount"
														       class="form-control form-control-solid"
													...
													<div class="row">
													    <div class="col-xl-6">
														   <div class="form-group">
														    <label>Asset Percent :</label><input type="text"
														        name="asset_percent" id="asset_percent"
														        class="form-control form-control-solid"
														        placeholder="Enter Asset Percent" />
														   </div>
														 </div> 
														 <div class="col-xl-6">
													<div class="form-group">
														<label>Asset Desc :</label>
														<textarea id="asset_desc"
                                                       ...
                                                       <div class="row">
                                                        <div class="col-lg-6">
																	...
																	<label>Asset Scan Pdf Name:</label><br>
																		<button type="button" id="asset_scan_pdf_name"
												                         class="btn btn-primary mr-2" >Asset Scan Pdf Name Button</button>
													...
													<div class="text-center">
														<button type="submit" id="addasset"
															class="btn btn-primary mr-2"
															>Submit</button>
														<button type="submit" id="updateasset"
															class="btn btn-primary mr-2"
															>Update</button>
									...
									<div class="example mb-10">
										<div class="example-preview">
											...
											<table data-toggle="table" class='a'
												...
												data-scroll="false" data-height=380 id="table-id">
												<thead>
													<tr>
														<th class="col-sm-1 text-center" data-field="no"
															data-sortable="true">No</th>
														<th class="col-sm-2 text-center" data-field="asset-name"
															data-sortable="true">Asset Name</th>
														<th class="col-sm-2 text-center" data-field="asset-code"
															data-sortable="true">Asset Code</th>
														<th class="col-sm-2 text-center" data-field="asset-price"
														    data-sortable="true">Asset Price</th>
														<th class="col-sm-2 text-center" data-field="asset-amount"
														    data-sortable="true">Asset Amount</th>
														<th class="col-sm-2 text-center" data-field="asset-percent"
														    data-sortable="true">Asset Percent</th>
														<th class="col-sm-2 text-center" data-field="asset-scan-pdf-name"
														    data-sortable="true">Asset Scan Pdf Name</th>
														<th class="col-sm-2 text-center" data-field="asset-desc"
														    data-sortable="true">Asset Description</th>
...
<script type="text/javascript">
	...
	$("#addasset").show();
		...
		$('#addasset').click(function() {
							...
							var asset_percent = $('#asset_percent').val();
		 ...
		 function update(id){
				...
				$.ajax({
			        ...
			        success:function(data)
			        {
			            ...
			            $("#asset_percent").val(row.asset_percent);
