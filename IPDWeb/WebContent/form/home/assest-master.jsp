									...
									<form class="form" id="kt_form_1">
										<div class="card-body">
												...
												<div class="col-xl-6">
													<div class="form-group">
														<label>Asset Name :</label> <input type="text"
															id="asset_name" class="form-control form-control-solid"
												...
												<div class="col-xl-6">
													<div class="form-group">
														<label>Asset Code :</label> <input type="text"
															id="asset_code" class="form-control form-control-solid"
												...
												<div class="col-xl-6">
													<div class="form-group">
														<label>Asset Price :</label><input type="text"
															id="asset_price" class="form-control form-control-solid"
											...
											<div class="row">
												<div class="col-xl-6">
													<div class="form-group">
														<label>Asset Scan PDF Name :</label><input type="text"
															id="asset_scan_pdf_name"
															class="form-control form-control-solid" placeholder="Enter Asset Scan PDF Name" />

													</div>
												</div>
												<div class="form-group col-xl-6">
													<label>Asset Amount :</label><input type="text"
														id="asset_amount" class="form-control form-control-solid"
														placeholder="Enter Asset Price" />
										...
										<table data-toggle="table" class='a'
											...
											<thead>
												<tr>
													...
													<th class="col-sm-3 text-center" data-field="asset-name"
														data-sortable="true">Asset Name</th>
													<th class="col-sm-3 text-center" data-field="asset-code"
														data-sortable="true">Asset Code</th>
													<th class="col-sm-3 text-center" data-field="asset-price"
														data-sortable="true">Asset Price</th>
													<th class="col-sm-3 text-center" data-field="asset-can-pdf"
														data-sortable="true">Asset Scan PDF</th>
													<th class="col-sm-3 text-center" data-field="asset-amount"
