...
<body id="kt_body"
	...
	<div class="container" >
				<h2 class="text-gray font-weight-bold my-2 mr-5">Assets Master</h2>
									...
									<form class="form" id="kt_form_1">
										<div class="card-body">
											<div class="row">
												<div class="col-xl-6">
													<div class="form-group">
														<label>Assets Name</label> <input type="text"
															id="assets_name" class="form-control form-control-solid"
															placeholder="Enter Assets Name" />
													</div>
												</div>
												<div class="col-xl-6">
													<div class="form-group">
														<label>Assets Code</label> <input type="text"
															id="assets_code" class="form-control form-control-solid"
											...
											<div class="row">
												<div class="col-xl-6">
													<div class="form-group">
														<label>Assets Price</label><input type="text"
															id="assets_price" class="form-control form-control-solid"
												...
												<div class="col-xl-6">
													<div class="form-group">
														<label>Assets Desc</label>
														<textarea id="assets_desc"
											...
											<div class="row">
												<div class="col-xl-6">
													<div class="form-group">
														<label>Assets Scan PDF</label><input type="text"
															id="assets_scan_pdf"
												...
												<div class="form-group col-xl-6">
													<label>Assets Amount</label><input type="text"
														id="assets_amount" class="form-control form-control-solid"
														placeholder="Enter Assets Price" />
											...
											<div class="row">
												<div class="col-xl-6">
													<div class="form-group">
														<label>Percent</label><input type="text"
															id="percent"
															class="form-control form-control-solid" />
										...
										<table data-toggle="table" class='a'
											...
											<thead>
												<tr>
													...
													<th class="col-sm-3 text-center" data-field="assets-name"
														data-sortable="true">Assets Name</th>
													<th class="col-sm-3 text-center" data-field="assets-code"
														data-sortable="true">Assets Code</th>
													<th class="col-sm-3 text-center" data-field="assets-price"
														data-sortable="true">Assets Price</th>
													<th class="col-sm-3 text-center" data-field="assets-can-pdf"
														data-sortable="true">Assets Scan PDF</th>
													<th class="col-sm-3 text-center" data-field="assets-amount"
														data-sortable="true">Assets Amount</th>
													<th class="col-sm-3 text-center" data-field="percent"
														data-sortable="true">Percent</th>
