...
<body id="kt_body"
	style="background-image: url(<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/ipd-opd/media/bg/LOGO-11.jpg)"
														...
														<form class="form" id="kt_form_1">
															<div class="card-body">
																<div class="form-group">
																	<label>Advice Name</label> <input type="text"
																		name="advice_name" id="advice_name"
							...
							<div class="col-xl-12 offset-xl-0 ">
								...
								<br />
										...
										<table data-toggle="table" class='a'
											...
											<thead>
												<tr>
													<th class="col-sm-1 text" data-field="NO"
														data-sortable="true">No</th>
													<th class="col-sm-4 text" data-field="advice_name"
														data-sortable="true">Advice Name</th>
													<th class="col-sm-5 text" data-field="advice_desc"
														data-sortable="true">Advice Detail</th>
													<th class="col-sm-2 text" data-field="Action"
