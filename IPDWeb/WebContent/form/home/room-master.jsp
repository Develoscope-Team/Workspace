						...
						<div class="card card-custom">
							<form class="form" id="kt_form_1">
								...
								<div class="text-center">
									...
									<button type="submit" id="updateRoom" 
...
<script type="text/javascript">
	...
	$("#addRoom").show();
		...
		$('#addRoom').click(function() {
						...
						if(room_name != "" && wards != ""){
							$.ajax({
								// http://localhost:8080/ipdAPI/ipdapi/insertUpdateRoom
								url : base +"/ipdAPI/ipdapi/insertUpdateRoom",
								...
								success : function(response) {
									if (response != null) {
										...
										if (response >= 1) {
											...
											var msg = "Room Data inserted Successfully.";
											alert(msg);
...
$.ajax({
	...
	url : base +"/ipdAPI/ipdapi/getRoom",
		 ...
		 function update(id){
				...
				$.ajax({
			        ...
			        success:function(data)
			        {
			            ...
			            const row = data.find(d => d.room_id ==id);
			           
			            $("#room_name").val(row.room_name);
			        	$("#wards").val(row.wards);
			        	$("#room_no").val(row.room_no);
			        	$("#number_of_beds").val(row.number_of_beds);
										...
										success : function(response) {
											if (response != null) {
												...
												if (response >= 1) {
													...
													var msg = "Room Data updated Successfully.";
													alert(msg);
				...
				success : function(response) {
					if (response != null) {
						...
						if (response >=1) {
							...
							var msg = "Room Data deleted Successfully.";
							alert(msg);
