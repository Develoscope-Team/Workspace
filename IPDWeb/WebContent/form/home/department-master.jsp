...
<body id="kt_body"
	...
	<div
		class="container">
				...
				<h2 class="text-gray font-weight-bold my-2 mr-5">Department Master</h2>
				<div class="row">
				<div class="col-xl-6 ">
										...
										<div class="text-center">
											<button type="button" id="addDepartment"
												class="btn btn-primary mr-2" >Submit</button>
													<button type="submit" id="updateDepartment"
												class="btn btn-primary mr-2"
												>Update</button>
											<button type="button" class="btn btn-primary mr-2" id="cancel">Cancel</button>
										</div>
									</form>
									<!--end::Form-->
								</div>
	...
	$("#addDepartment").show();
		...
		$('#addDepartment').click(function() {
						...
						if(department_name != "" && department_code != ""){
							$.ajax({
								// http://localhost:8080/ipdAPI/ipdapi/insertUpdateDepartment
								url : base +"/ipdAPI/ipdapi/insertUpdateDepartment",
								...
								success : function(response) {
									if (response != null) {
										...
										if (response >= 1) {
											...
											var msg = "Department Data inserted Successfully.";
											alert(msg);
...
$.ajax({
	...
	url : base +"/ipdAPI/ipdapi/getDepartment",
		 ...
		 function update(id){
				...
				$.ajax({
			        ...
			        success:function(data)
			        {
			            ...
			            const row = data.find(d => d.department_id ==id);
			           
			            $("#department_name").val(row.department_name);
			        	$("#department_code").val(row.department_code);
										...
										success : function(response) {
											if (response != null) {
												...
												if (response >= 1) {
													...
													var msg = "Department Data updated Successfully.";
													alert(msg);
				...
				success : function(response) {
					if (response != null) {
						...
						if (response >=1) {
							...
							var msg = "Department Data deleted Successfully.";
							alert(msg);
