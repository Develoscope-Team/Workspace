...
<script type="text/javascript">
	...
	$("#addbranch").show();
		...
		$('#addbranch').click(function() {
							...
							var branc_address = $('#branch_address').val();
						...
						if(bank_name != "" ){
							$.ajax({
								// http://localhost:8080/ipdAPI/ipdapi/insertUpdatebranch
								url : base +"/ipdAPI/ipdapi/insertUpdatebranch",
								...
								success : function(response) {
									if (response != null) {
										...
										if (response >= 1) {
											...
											var msg = "Branch Data inserted Successfully.";
											alert(msg);
...
$.ajax({
	...
	url : base +"/ipdAPI/ipdapi/getbranch",
		 ...
		 function update(id){
				...
				$.ajax({
			        ...
			        success:function(data)
			        {
			            ...
			            const row = data.find(d => d.branch_id ==id);
			           
			            $("#branch_name").val(row.branch_name);
			        	$("#branch_code").val(row.branch_code);
			        	$("#branch_address").val(row.branch_address);
			        	$("#branch_manager").val(row.branch_manager);
			        	 $("#city").val(row.city);
				...
				.click(
						function() {
							...
							var branch_manager = $('#branch_managr').val();
							var city= $('#city').val();
							var district = $('#district').val();
							var state = $('#state').val();
							var phone_no = $('#phone_no').val();
										...
										success : function(response) {
											if (response != null) {
												...
												if (response >= 1) {
													...
													var msg = "Branch Data updated Successfully.";
													alert(msg);
				...
				success : function(response) {
					if (response != null) {
						...
						if (response >=1) {
							...
							var msg = "Branch Data deleted Successfully.";
							alert(msg);
