...
<body id="kt_body"
	...
	class="quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled page-loading">
		...
		class="container">
				...
				<h2 class="text-gray font-weight-bold my-2 mr-5">Ward Transfer Screen</h2>
												...
												<div class="col-xl-6">
													...
													<div class="form-group">
														<label>Patient Code</label> <input type="text"
															id="patientCode" class="form-control form-control-solid"
															 />
													</div>
												</div>
															</div>
															<div class="row">
																<div class="col-lg-6">
																	<div class="form-group">
																		<label>Ward No</label> <input type="number"
																			class="form-control form-control-solid"
																			id="wardNo" /> <span class="msg text-danger"
																			id="type2"> </span>
																	</div>
																</div>
																<div class="col-xl-6">
																	<div class="form-group">
																		...
																		<div class="typeahead">
																			<input type="text"
																				class="form-control form-control-solid form-control-lg"
																				name="wardName" id="wardName" /><span
																				class="msg text-danger" id="type1"> </span>
																		</div>
															...
															<div class="row">
																<div class="col-lg-6">
																	<div class="form-group">
																		<label>Transfer In Which Ward</label> <input type="number"
																			class="form-control form-control-solid"
																			id="transferInWhichWard" /> <span class="msg text-danger"
																			id="type2"> </span>
																	</div>
																</div>
															</div>
