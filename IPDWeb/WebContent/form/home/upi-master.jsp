...
<script type="text/javascript">
	...
	$("#addupi").show();
		...
		$('#addupi').click(function() {
						...
						if(upi_name != "" && upi_desc != ""){
							$.ajax({
								// http://localhost:8080/ipdAPI/ipdapi/insertUpdateupi
								url : base +"/ipdAPI/ipdapi/insertUpdateupi",
