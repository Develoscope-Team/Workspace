													...
													<div class="form-group">
														<label>Designation Code :</label> <input type="text"
															...
															<div class="text-center">
																<button type="button" id="addDesignation"
																	class="btn btn-primary mr-2" >Submit</button>
																<button type="submit" id="updateDesignation"
...
<script type="text/javascript">
	...
	$("#addDesignation").show();
		...
		$('#addDesignation').click(function() {
						...
						if(designation_name != "" && designation_code != ""){
							$.ajax({
								// http://localhost:8080/ipdAPI/ipdapi/insertUpdateDesignation
								url : base +"/ipdAPI/ipdapi/insertUpdateDesignation",
								...
								success : function(response) {
									if (response != null) {
										...
										if (response >= 1) {
											...
											var msg = "Designation Data inserted Successfully.";
											alert(msg);
...
$.ajax({
	...
	url : base +"/ipdAPI/ipdapi/getDesignation",
		 ...
		 function update(id){
				...
				$.ajax({
			        ...
			        success:function(data)
			        {
			            ...
			            const row = data.find(d => d.designation_id ==id);
			           
			            $("#designation_name").val(row.designation_name);
			        	$("#designation_code").val(row.designation_code);
										...
										success : function(response) {
											if (response != null) {
												...
												if (response >= 1) {
													...
													var msg = "Designation Data updated Successfully.";
													alert(msg);
				...
				success : function(response) {
					if (response != null) {
						...
						if (response >=1) {
							...
							var msg = "Designation Data deleted Successfully.";
							alert(msg);
