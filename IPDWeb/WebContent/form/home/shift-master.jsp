...
<body id="kt_body"
	...
	<div class="container">
		...
		<h2
			class="d-flex align-items-center text-dark font-weight-bold my-1 mr-3">Shift
			Master</h2>
								...
								<div class="card card-custom">
									<form class="form" id="kt_form_1">
											...
											<div class="col-xl-6">
												<div class="form-group">
													<label>Shift Name :</label> <input type="text"
														id="shift _name" class="form-control form-control-solid"
														placeholder="Enter Shift Name" />
												</div>
											</div>
											<div class="col-xl-6">
												<div class="form-group">
													<label>Shift Code :</label> <input type="text"
														id="shift_code" class="form-control form-control-solid"
												...
												<div class="form-group">
													...
													<div class="typeahead">
														<input type="time" class="form-control form-control-solid"
															id="pmt" name="pmt" min="00:00" max="24:00">
													</div>
												</div>
											</div>
										...
										<div class="text-center">
											...
											<button type="submit" id="updateshift"
												class="btn btn-primary mr-2"
						...
						<table data-toggle="table" class='a'
							...
							<thead>
								<tr>
									...
									<th class="col-sm-3 text-center" data-field="shift-name"
										data-sortable="true">Shift Name</th>

									<th class="col-sm-3 text-center" data-field="shift-code"
										data-sortable="true">Shift Code</th>
									<th class="col-sm-3 text-center" data-field="time-from"
										data-sortable="true">Time From</th>
									<th class="col-sm-3 text-center" data-field="to-time"
										data-sortable="true">To Time</th>
...
<script type="text/javascript">
	...
	$("#addshift").show();
		...
		$('#addshift').click(function() {
						...
						if(shift_name != "" ){
							$.ajax({
								// http://localhost:8080/ipdAPI/ipdapi/insertUpdateshift
								url : base +"/ipdAPI/ipdapi/insertUpdateshift",
								...
								success : function(response) {
									if (response != null) {
										...
										if (response >= 1) {
											...
											var msg = "shift Data inserted Successfully.";
											alert(msg);
...
$.ajax({
	...
	url : base +"/ipdAPI/ipdapi/getshift",
		 ...
		 function update(id){
				...
				$.ajax({
			        ...
			        success:function(data)
			        {
			            ...
			            const row = data.find(d => d.shift_id ==id);
			           
			            $("#shift_name").val(row.shift_name);
			        	$("#shift_code").val(row.shift_code);
										...
										success : function(response) {
											if (response != null) {
												...
												if (response >= 1) {
													...
													var msg = "shift Data updated Successfully.";
													alert(msg);
				...
				success : function(response) {
					if (response != null) {
						...
						if (response >=1) {
							...
							var msg = "shift Data deleted Successfully.";
							alert(msg);
