													...
													<div class="form-group">
														<label>Amount Charges :</label> <input type="text"
															...
															<div class="text-center">
																...
																<button type="submit" id="updateFacility"
...
<script type="text/javascript">
	...
	$("#addFacility").show();
		...
		$('#addFacility').click(function() {
							...
							var amount_charges = $('#amount_charges').val();
							var flag = 1; // Addition

						if(facility_name != "" && amount_charges != ""){
							$.ajax({
								// http://localhost:8080/ipdAPI/ipdapi/insertUpdateFacility
								url : base +"/ipdAPI/ipdapi/insertUpdateFacility",
								...
								success : function(response) {
									if (response != null) {
										...
										if (response >= 1) {
											...
											var msg = "Facility Data inserted Successfully.";
											alert(msg);
...
$.ajax({
	...
	url : base +"/ipdAPI/ipdapi/getFacility",
		 ...
		 function update(id){
				...
				$.ajax({
			        ...
			        success:function(data)
			        {
			            ...
			            const row = data.find(d => d.facility_id ==id);
			           
			            $("#facility_name").val(row.facility_name);
			        	$("#amount_charges").val(row.amount_charges);
										...
										success : function(response) {
											if (response != null) {
												...
												if (response >= 1) {
													...
													var msg = "Facility Data updated Successfully.";
													alert(msg);
				...
				success : function(response) {
					if (response != null) {
						...
						if (response >=1) {
							...
							var msg = "Facility Data deleted Successfully.";
							alert(msg);
