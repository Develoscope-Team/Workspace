...
<script type="text/javascript">
	...
	$("#addLabtest").show();
		...
		$('#addLabtest').click(function() {
						...
						if(test_name != "" && sub_department != ""){
							$.ajax({
								// http://localhost:8080/ipdAPI/ipdapi/insertUpdateLabtest
								url : base +"/ipdAPI/ipdapi/insertUpdateLabtest",
								...
								success : function(response) {
									if (response != null) {
										...
										if (response >= 1) {
											...
											var msg = "Labtest Data inserted Successfully.";
											alert(msg);
		 ...
		 function update(id){
				...
				$.ajax({
			        ...
			        success:function(data)
			        {
			            ...
			            const row = data.find(d => d.labtest_id ==id);
			           
			            $("#test_name").val(row.test_name);
			        	$("#sub_department").val(row.sub_department);
										...
										success : function(response) {
											if (response != null) {
												...
												if (response >= 1) {
													...
													var msg = "Labtest Data updated Successfully.";
													alert(msg);
				...
				success : function(response) {
					if (response != null) {
						...
						if (response >=1) {
							...
							var msg = "Labtest Data deleted Successfully.";
							alert(msg);
