...
<body id="kt_body"
	...
	<div class="container">
							...
							<h2
								class="d-flex align-items-center text-purple font-weight-bold my-1 mr-3">medicine category
								Master</h2>
													...
													<div class="card card-custom">
														<form class="form" id="kt_form_1">
															...
															<div class="form-group">
																	<label>Medicine category</label><span class="text-danger"
																		id="type">*</span> <input type="text"
																		name="medicine_category" id="medicine_category"
																		class="form-control form-control-solid"
																		placeholder="Enter mediine category" required />
																</div>
																
															</div>
															<div class="text-center">
																<button type="submit" id="addmedicine_category"
																	class="btn btn-primary mr-2">Submit</button>
																<button type="submit" id="updatemedicine_category"
											...
											<thead>
												<tr>
													...
													<th class="col-sm-3 text-center"
														data-field="medicine-category" data-sortable="true">Medicine category</th>
...
<script type="text/javascript">
	...
	$('#updatemedicine_category').hide();
	$("#addmedicine_category").show();
	
		$('#addmedicine_category').click(function() {
						...
						if(medicine_category !=  ""){
							$.ajax({
								// http://localhost:8080/ipdAPI/ipdapi/insertUpdatemedicine_category
								url : base +"/ipdAPI/ipdapi/insertUpdatemedicine_category",
								...
								success : function(response) {
									if (response != null) {
										...
										if (response >= 1) {
											...
											var msg = "medicine_category Data inserted Successfully.";
											alert(msg);
...
$.ajax({
	...
	url : base +"/ipdAPI/ipdapi/getmedicine_category",
	
	type : "post",
	dataType : "json",
	async : false,
	data : {"medicine_category": medicine_category_id},
...
$(document).ready(function (){
	   var table = $('#table-id').DataTable();
		 ...
		 function update(id){
				...
				$('.btn_medicine_category').hide();
				

				
				$('#updatemedicine_category').show();
				$("#addmedicine_category").hide();
										...
										success : function(response) {
											if (response != null) {
												...
												if (response >= 1) {
													...
													var msg = "Medicine_Category Data updated Successfully.";
													alert(msg);
				...
				success : function(response) {
					if (response != null) {
						...
						if (response >=1) {
							...
							var msg = "Medicine_Category Data deleted Successfully.";
							alert(msg);
