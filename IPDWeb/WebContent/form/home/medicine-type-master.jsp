...
<body id="kt_body"
	...
	<div class="container-fluid offset-1">
							...
							<h2
								class="d-flex align-items-center text-purple font-weight-bold my-1 mr-3">Medicine Type
								Master</h2>
													...
													<div class="card card-custom">
														<form class="form" id="kt_form_1">
															...
															<div class="form-group">
																	<label>Medicine Type</label><span class="text-danger"
																		id="type">*</span> <input type="text"
																		name="Medicine Type" id="medicine_type"
																		class="form-control form-control-solid"
																		placeholder="Enter mediine Type" required />
																</div>
																
															</div>
															<div class="text-center">
																<button type="submit" id="addmedicine_type"
																	class="btn btn-primary mr-2">Submit</button>
																<button type="submit" id="updatemedicine_type"
											...
											<thead>
												<tr>
													...
													<th class="col-sm-3 text-center"
														data-field="Medicine_Type" data-sortable="true">Medicine Type</th>
...
<script type="text/javascript">
	...
	$('#updatemedicine_type').hide();
	$("#addmedicine_type").show();
	
		$('#addmedicine_tyope').click(function() {

							var medicine_type = $('#medicine_type').val();
							
							var flag = 1; // Addition

						if(medicine_type != "" && medicine_type != ""){
							$.ajax({
								// http://localhost:8080/ipdAPI/ipdapi/insertUpdatemedicine_type
								url : base +"/ipdAPI/ipdapi/insertUpdatemedicine_type",
								...
								success : function(response) {
									if (response != null) {
										...
										if (response >= 1) {
											...
											var msg = "Medicine_Type Data inserted Successfully.";
											alert(msg);
...
$(document).ready(function (){
	   var table = $('#table-id').DataTable();
		 ...
		 function update(id){
				...
				$('.btn_medicine_type').hide();
				

				
				$('#updatemedicine_type').show();
				$("#addmedicine_type").hide();
				
				$.ajax({
			        type:"POST",
			        dataType: "json",
			        data:{"medicine_type_id": id},
					async : false,
					url : base +"/ipdAPI/ipdapi/getmedicine_type",
			        success:function(data)
			        {
			        	
			            const row = data.find(d => d.medicine_type_id ==id);
										...
										success : function(response) {
											if (response != null) {
												...
												if (response >= 1) {
													...
													var msg = "medicine_type Data updated Successfully.";
													alert(msg);
				...
				success : function(response) {
					if (response != null) {
						...
						if (response >=1) {
							...
							var msg = "Medicine_type Data deleted Successfully.";
							alert(msg);
