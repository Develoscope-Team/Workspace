...
<body id="kt_body"
	...
	<div class="container " >
				<h2 class="text-gray font-weight-bold my-2 mr-5">Payment Master</h2>
		<div class="row">
		<div class="col-xl-6 ">
								...
								<div class="card card-custom">
									<form class="form" id="kt_form_1">
										...
										<div class="text-center">
											...
											<button type="submit" id="updatePayment"
										...
										<table data-toggle="table" class='a'
											...
											<thead>
												<tr>
													...
													<th class="col-sm-3 text-center" data-field="bank"
														data-sortable="true">bank</th>
...
<script type="text/javascript">
	...
	$("#addPayment").show();
		...
		$('#addPayment').click(function() {
						...
						if(payment_mode != "" && bank_name != ""){
							$.ajax({
								// http://localhost:8080/ipdAPI/ipdapi/insertUpdatePayment
								url : base +"/ipdAPI/ipdapi/insertUpdatePayment",
								...
								success : function(response) {
									if (response != null) {
										...
										if (response >= 1) {
											...
											var msg = "Payment Data inserted Successfully.";
											alert(msg);
...
$.ajax({
	...
	url : base +"/ipdAPI/ipdapi/getPayment",
		 ...
		 function update(id){
				...
				$.ajax({
			        ...
			        success:function(data)
			        {
			            ...
			            const row = data.find(d => d.payment_id ==id);
				...
				success : function(response) {
					if (response != null) {
						...
						if (response >=1) {
							...
							var msg = "Payment Data deleted Successfully.";
							alert(msg);
