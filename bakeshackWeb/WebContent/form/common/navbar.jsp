	...
	<div
			...
			<div class="header-menu-wrapper header-menu-wrapper-left"
				...
				<div id="kt_header_menu"
					...
					<ul class="menu-nav">
								...
								<ul class="menu-subnav">
									...
									<li class="menu-item" aria-haspopup="true"><a
										href="recipe-master.jsp" class="menu-link"> <i
											class="menu-bullet menu-bullet-dot"> <span></span>
										</i> <span class="menu-text">Reciepe Master</span>
									</a></li>
									<li class="menu-item" aria-haspopup="true"><a
									...
									<!-- <li class="menu-item" aria-haspopup="true"><a
										href="demopayment.jsp" class="menu-link"> <i
											class="menu-bullet menu-bullet-line"> <span></span>
										</i> <span class="menu-text">Payment Master</span>
									</a></li> -->
									<li class="menu-item" aria-haspopup="true"><a
						...
						<li class="menu-item menu-item-submenu menu-item-rel"
							data-menu-toggle="click" aria-haspopup="true"><a href="javascript:;" class="menu-link menu-toggle">
														...
														<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
															<a href="javascript:;" class="menu-link menu-toggle">
																<span class="svg-icon menu-icon">
																	<!--begin::Svg Icon | path:assets/BakeShack_IM/media/svg/icons/Shopping/Box2.svg-->
										...
										href="order_delivery.jsp" class="menu-link"> <i
											class="menu-bullet menu-bullet-dot"> <span></span>
												...
												<!-- <li class="menu-item" aria-haspopup="true"><a
										href="sales-order-master.jsp" class="menu-link"> <i
											class="menu-bullet menu-bullet-dot"> <span></span>
									...
									<li class="menu-item" aria-haspopup="true"><a
										href="purchase_order_conformation.jsp" class="menu-link"> <i
											class="menu-bullet menu-bullet-dot"> <span></span>
										</i> <span class="menu-text">Purchase Billing </span>
									</a></li>
									<!-- <li class="menu-item" aria-haspopup="true"><a
										href="purchase-master.jsp" class="menu-link"> <i
											class="menu-bullet menu-bullet-dot"> <span></span>
										</i> <span class="menu-text">Purchase </span>
									</a></li> -->
									<li class="menu-item" aria-haspopup="true"><a
										href="purchase_return_screen.jsp" class="menu-link"> <i
											class="menu-bullet menu-bullet-dot"> <span></span>
														...
														<li class="menu-item" aria-haspopup="true">
																					<a href="production-master.jsp" class="menu-link">
														...
														<li class="menu-item" aria-haspopup="true">
																					<a href="expiry_good.jsp" class="menu-link">
																						<i class="menu-bullet menu-bullet-dot">
																							<span></span>
																						</i>
																						<span class="menu-text">Expiry Goods</span>
																					</a>
																				</li>
																				<li class="menu-item" aria-haspopup="true"><a
					...
					<div class="quick-search quick-search-dropdown "
						...
						<form method="get" class="quick-search-form">
							<div class="input-group">
								...
								<input type="text" class="form-control typeahead" id="global_search" placeholder="" />
				...
				<!--begin::Dropdown-->
					...
					<form>
						...
						<div
							...
							<h4 class="text-white m-0 flex-grow-1 mr-3">Orders Notifications</h4>
							<button type="button" class="btn btn-success btn-sm" id="order_count">2
								Items</button>
						</div>
						<!--end::Header-->
						<!--begin::Scroll-->
						<div class="scroll scroll-push" data-scroll="true"
							...
							<table data-toggle="table" class='a'
											...
											<thead>
												<tr>
													<th class="col-sm-2 text-center" data-field="customer-Name"
														data-sortable="true">Customer Name</th>
														<th class="col-sm-2 text-center" data-field="delivery-date"
				...
				<div
					...
					<form>
						...
						<div
							...
							<h4 class="text-white m-0 flex-grow-1 mr-3">Customer Outstanding</h4>
							<button type="button" class="btn btn-success btn-sm" id="customer_count">2
								Items</button>
						</div>
						<!--end::Header-->
						<!--begin::Scroll-->
						...
						<div class="p-8">
							<div
								class="d-flex align-items-center justify-content-between mb-4">
								<span class="font-weight-bold text-muted font-size-sm mr-2">Total</span>
								<span class="font-weight-bolder text-dark-50 text-right" id="balance_total1"></span>
							</div>
				...
				<div
					...
					<form>
						...
						<div
							...
							<h4 class="text-white m-0 flex-grow-1 mr-3">Vendors Outstanding</h4>
							<button type="button" class="btn btn-success btn-sm" id="vendors_count">2
								Items</button>
						</div>
						<!--end::Header-->
						<!--begin::Scroll-->
		...
		<div class="offcanvas-content pr-5 mr-n5">
			...
			<div class="separator separator-dashed mt-8 mb-5"></div>
	         ...
	         <a href="customer_outstanding.jsp" class="mb-5">Customer OutStanding</a></br>
	           <a href="vendors_outstanding.jsp" class="mb-5">Vendors OutStanding</a>
	        <div class="separator separator-dashed mt-8 mb-5"></div>
			<!--end::Separator-->
			<!--begin::Notifications-->
			<div>
				...
				<div
					...
					<div class="d-flex flex-column flex-grow-1 mr-2">
						<a href="#"
							class="font-weight-normal text-dark-75 text-hover-primary font-size-lg mb-1">Sale</a> <span class="text-muted font-size-sm">
							in 1 Days</span>
					</div>
					<span class="font-weight-bolder text-warning py-1 font-size-lg" id="todays_sale_amount">-</span>
				</div>
				<!--end::Item-->
				<!--begin::Item-->
				<div
					...
					<div class="d-flex flex-column flex-grow-1 mr-2">
						<a href="#"
							class="font-weight-normal text-dark-75 text-hover-primary font-size-lg mb-1">Total Purchase</a> <span class="text-muted font-size-sm"> in
							1 Days</span>
					</div>
					<span class="font-weight-bolder text-success py-1 font-size-lg" id="total_todays_purchase">-</span>
				</div>
				<!--end::Item-->
				<!--begin::Item-->
				<div
					...
					<div class="d-flex flex-column flex-grow-1 mr-2">
						<a href="#"
							class="font-weight-normel text-dark-75 text-hover-primary font-size-lg mb-1">Cash In Hand</a> <span class="text-muted font-size-sm">
							in 1 Days</span>
					</div>
					<span class="font-weight-bolder text-danger py-1 font-size-lg" id="cash_in_hand">-</span>
				</div>
				<!--end::Item-->
				<!--begin::Item-->
				<div class="d-flex align-items-center bg-light-info rounded p-5">
					...
					<div class="d-flex flex-column flex-grow-1 mr-2">
						<a href="#"
							class="font-weight-normel text-dark-75 text-hover-primary font-size-lg mb-1">Total Outstanding</a> <span class="text-muted font-size-sm"> in
							1 Days</span>
					</div>
					<span class="font-weight-bolder text-info py-1 font-size-lg" id="todays_total_outstanding">-</span>
				</div>
				<!--end::Item-->
			</div>
			...
			data.forEach((row)=> {
				product_order_count++;
				 ...
				 html1 +="<tr id= tr-id-2 class= tr-class-2>";
					html1 += "<td onclick=myfunction1()>"+row.customer_name+"</td>"; 
					html1 += "<td>"+row.delivery_date+"</td><td>"; 
