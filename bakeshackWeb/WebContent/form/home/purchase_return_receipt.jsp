...
<body onafterprint="printP()" id="kt_body"
   ...
   <jsp:include page="/form/common/mobile-header.jsp"></jsp:include> 
							...
							<div class="card card-custom overflow-hidden">
								<div class="card-body p-0">
									...
									<div class="row justify-content-center bgi-size-cover bgi-no-repeat">
										<div class="  col-md-10 ">
											<h1	class=" text-black font-weight-boldest mt-35  mb-20  text-center ml-25 ">
												<u>PURCHASE RETURN RECEIPT</u>
											</h1>
	...
	var j=0;
	 ...
	 var bank = "";
	$.ajax({
		url : base + "/bakeshackAPI/api/getPurchaseAndReturnDetails",
		type : "post",
		dataType : "json",
		async : false,
		...
		success:function(data)
	{
			...
			data.forEach((row)=> {
				...
				if(row.order_code == order_code )
						{
					amount_in_word = row.total_amount;
