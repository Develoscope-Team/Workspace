	...
	$.ajax({
		...
		success:function(data)
	    {
			...
			data.forEach((row)=> {
				...
				/*  var today = row.paid_date;
				 var date = today.getDate()+'-'+(today.getMonth()+1)+'-'+today.getFullYear();	 */
				
				
	     	html +="<tr id= tr-id-2 class= tr-class-2>"
	        html += "<td style='border-right:1px solid black; border-left:1px solid black'>"+row.paid_date+"</td>";
			...
			html += "<td>"+row.invoice_id+"</td>"; 
	         ...
	         html += "<td style='border-right:1px solid black'>"+row.paid_date+"</td>";
	         html += "<td></td>"; 
	         html += "<td></td>";
	         html += "<td></td>";
