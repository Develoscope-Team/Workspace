								...
								var jsonString = JSON.stringify(productList);	
								 $.ajax({
										...
										data : {
											...
											"upi_name" : upi_name,
											"total_amount" :parseInt(amount)-parseInt(discount)+parseInt(delivery_charges),
											"partial_paid_amount" : parseInt(partial_paid_amount)+parseInt(advance_paid),
											"balance_amount" : parseInt(amount)+parseInt(delivery_charges)-parseInt(advance_paid)-parseInt(discount)-parseInt(partial_paid_amount),
