						...
						<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
							...
							<div class="d-flex align-items-center flex-wrap mr-1">
								...
								<div class="d-flex flex-column">
									<!--begin::Title-->
									<h2 class="text-white font-weight-bold my-2 mr-5">Product Wise Purchese Report</h2>
									<!--end::Title-->
								</div>
								<!--end::Heading-->
							</div>
	 ...
	 $('#from_date,#till_date').datepicker({
	  ...
	  format: 'yyyy-mm-dd'
		    ...
		    function printP() {
			  ...
			  var url ="product_purchase_report_print.jsp" + '?product_code=' + product_code  + '&product_name=' + product_name  +  '&from_date=' + from_date + '&till_date=' + till_date ;
