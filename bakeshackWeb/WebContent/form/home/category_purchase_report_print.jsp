...
<body id="kt_body"
	...
	<div class="card card-custom gutter-b ">
		...
		<div class=" " id="card_Report">
			<font size="+3"><u><center>Category Wise Purchese Report</center></u></font> <br />
			<div class=" mr-10 " >
...
<script type="text/javascript"
	...
	var base='<%=base%>';
	 ...
	 var category_name = " ";
		...
		const category_code = urlParams.get('category_code');
	...
	var html;
	$.ajax({
		url : base + "/bakeshackAPI/api/getPurchaseProductCategoryReportDetails",
		type : "post",
		dataType : "json",
		async : false,
		data : {
