						...
						<div
							...
							<div class="d-flex align-items-center flex-wrap mr-1">
								...
								<div class="d-flex flex-column">
									<!--begin::Title-->
									<h2 class="text-white font-weight-bold my-2 mr-5">Unit
										Master</h2>
									<!--end::Title-->
	...
	var base='<%=base%>';
		...
		$('#addUnit').click(
						function() {
							...
							if (unit_desc != "" && unit_code != "") {
								$
										.ajax({
											url : base
													+ "/bakeshackAPI/api/insertUpdateUnit",
											type : "post",
											dataType : "json",
											async : false,
											data : {
											...
											error : function(xhr) {
												var msg = "(insertUpdateUnit)Sorry but there was an error : "
														+ xhr.status
														+ " "
														+ xhr.statusText;
									...
									columns : [
											...
											},
											{
												...
												template : function(row) {
													return '\
								                        <a href="javascript:updateById('+ row.unit_id +');" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">\
								                        ...
								                        <a href="javascript:deleteById('+ row.unit_id +');" class="btn btn-sm btn-clean btn-icon" title="Delete">\
								                            <span class="svg-icon svg-icon-md">\
								                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">\
								                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">\
								                                        <rect x="0" y="0" width="24" height="24"/>\
					...
					.click(
							function() {
								...
								if (unit_desc != '') {
									...
									$
											.ajax({
												url : base + "/bakeshackAPI/api/insertUpdateUnit",
												type : "post",
												dataType : "json",
												async : false,
												data : {
