...
<body id="kt_body"
	...
	<div class="card card-custom gutter-b ">
		...
		<div class=" " id="card_Report">
			...
			<div class=" mr-10 " >
			<font size="+2"><u><center>Vendors Outstanding <span class=" " id="finish"></span></center></u></font></div><br />
...
<script type="text/javascript"
	...
	const customer_code = urlParams.get('vcode');
	vendors_name = urlParams.get('query');
	
	var html;
	 $('#finish').text(vendors_name);
	
	
	$.ajax({
		url : base + "/bakeshackAPI/api/getVendorsOustandingForReport",
		type : "post",
		dataType : "json",
		async : false,
		data : {
	    ...
	    {
			/* alert("invoice_code"); */
			const row = data.find(d => d.vendors_name != '');
			data.forEach((row)=> {
