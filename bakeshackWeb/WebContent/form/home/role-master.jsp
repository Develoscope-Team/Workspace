...
.alert.hide {animation: hide_slide 1s ease forwards;}
.alert.showAlert {opacity: 1; pointer-events: auto;}
.alert.show {animation: show_slide 1s ease forwards;}
...
.alert-text {padding: 0 20px; font-size: 18px;}
</style>
												...
												<div class="example-preview">
													<div class="card card-custom">
														...
														<div class="checkbox-inline">
															...
															<span></span>Product Master</label>
															<label class="checkbox checkbox-outline">
															<input type="checkbox"  name="Checkboxes3" id="master_checkbox_5"/>
															<span></span>Recipe Master</label>
															<label class="checkbox checkbox-outline">
														...
														<div class="checkbox-inline">
															...
															<span></span>Bank Master</label>
															<label class="checkbox checkbox-outline mr-10">
														...
														<div class="checkbox-inline">
															...
															<span></span>Category Sale Report</label>
															<label class="checkbox checkbox-outline">
															<input type="checkbox" id="Reports_checkbox_6" name="Checkboxes3" />
															<span></span>Category Purchase Report</label>
															<label class="checkbox checkbox-outline">
															<input type="checkbox" id="Reports_checkbox_7" name="Checkboxes3" />
															<span></span>Monthly Product Report</label>
															<label class="checkbox checkbox-outline">
															<input type="checkbox" id="Reports_checkbox_8" name="Checkboxes3" />
															<span></span>Monthly Subcategory Report</label>
														</div>
														</div>
														...
														<div class="col-3">
 														<div class="checkbox-inline">
															<label class="checkbox checkbox-outline">
															<input type="checkbox" id="Reports_checkbox_9" name="Checkboxes3" />
															<span></span>In-Out Ledger</label>
															<label class="checkbox checkbox-outline">
															<input type="checkbox" id="Reports_checkbox_10" name="Checkboxes3" />
															<span></span>PNL Day Wise</label>
															<label class="checkbox checkbox-outline">
															<input type="checkbox" id="Reports_checkbox_11" name="Checkboxes3" />
															<span></span>PNL Month Wise</label>
															<label class="checkbox checkbox-outline">
															<input type="checkbox" id="Reports_checkbox_12" name="Checkboxes3" />
															<span></span>PNL Year Wise</label>
														</div>
														</div>
														</div>
														<br />
	...
	<div id="kt_scrolltop" class="scrolltop">
		<span class="svg-icon"> <!--begin::Svg Icon | path:assets/BakeShack_IM/media/svg/icons/Navigation/Up-2.svg-->
			<svg xmlns="http://www.w3.org/2000/svg"	xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
					<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><polygon points="0 0 24 0 24 24 0 24" /><rect fill="#000000" opacity="0.3" x="11" y="10" width="2"	height="10" rx="1" />
...
$.ajax({
	...
	function updateById(role_id) {
		...
		if(myArray[21] == "Y"){
			$("#Reports_checkbox_8").prop("checked", true);		
			}
		if(myArray[22] == "Y"){
			$("#Reports_checkbox_9").prop("checked", true);	
			}
		if(myArray[23] == "Y"){
			$("#Reports_checkbox_10").prop("checked", true);	
			}
		if(myArray[24] == "Y"){
			$("#Reports_checkbox_11").prop("checked", true);	
			}
		if(myArray[25] == "Y"){
			$("#Reports_checkbox_12").prop("checked", true);	
			}
	...
	var update_permission = [] ;	
		$('#updateRole').click(function() {
							...
							for(var i=1 ; i < 10 ; i++)
							{
								var master_checkbox = $("#master_checkbox_"+i).is(':checked');
								if(master_checkbox == true){
									update_permission.push("Y");
								}else{
									update_permission.push("N");
								}
							}
							for(var i=1 ; i < 6 ; i++)
							{
