						...
						<div
							...
							<div class="d-flex align-items-center flex-wrap mr-1">
								...
								<div class="d-flex flex-column">
									<!--begin::Title-->
									<h2 class="text-white font-weight-bold my-2 mr-5">Recipe
										Master</h2>
									<!--end::Title-->
															...
															<div class="row">
																...
																<div class="col-lg-6">
																	...
																	<label>Recipe Code</label>
																		<input type="text" id="recipe_code"
																			class="form-control form-control-solid"
...
<div class="modal" id="medicineModel" tabindex="-1"
							...
							<div class="col-xl-12 offset-xl-0">
								<div class="card card-custom gutter-b">
									<div class="card-body">
									<div class="input-icon ml-10" style = "width: 30%;">
																<input type="text" class="form-control form-control-solid" placeholder="Search..." id="txt_searchall1" />
																<span>
																	<i class="flaticon2-search-1 text-muted"></i>
																</span>
															</div>
										...
										<table data-toggle="table" class='a'
											...
											<thead>
												<tr>
													...
													<!-- <th class="col-sm-3 text-center" data-field="Raw-material"
														data-sortable="true">Raw Material </th>
 -->													
							...
							function() {
								...
								if (recipe_name != '') {
									...
									$
											.ajax({
												url : base
														+ "/bakeshackAPI/api/insertUpdateRecipe",
												type : "post",
												dataType : "json",
												async : false,
												data : {
