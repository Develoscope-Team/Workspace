						...
						<div
							...
							<div class="d-flex align-items-center flex-wrap mr-1">
								...
								<div class="d-flex flex-column">
									<!--begin::Title-->
									<h2 class="text-white font-weight-bold my-2 mr-5">Purchase Order Modification
										</h2>
						 ...
						 $('.add_product').on('click','.btn_delete',function(){
								$(this).closest('tr').remove();	
								 ...
								 for(var j = 1 ;j<100 ;j++)
								 {
									 ...
									 document.getElementById('total_amount').value = parseInt(calculate_total) - parseInt(discount) + parseInt(delivery_charges) ;
								 ...
								 */
								 ...
								 $.ajax({
										...
										data : {
											...
											"upi_name" : upi_name,
											"total_amount" : parseInt(amount)+parseInt(delivery_charges)-parseInt(discount),
											"partial_paid_amount" :parseInt( partial_paid_amount) + parseInt(advance_paid),
											"balance_amount" : parseInt(amount)+parseInt(delivery_charges)-parseInt(discount)-parseInt(advance_paid)-parseInt(partial_paid_amount),
											"received_bank" : received_bank,
											"account_no" : account_no,
											"product_list" : jsonString,
											"status" : 1,
											"advance_paid" : parseInt(partial_paid_amount)+parseInt(advance_paid),
											"flag" : 2
										},
										error : function(xhr) {
									 ...
									 $.ajax({
											...
											data : {
												...
												"to_be_paid"          : -(parseInt(amount)+parseInt(delivery_charges)-parseInt(discount)),
												"payment_mode"        : payment_mode,
												"paid_amount"         : -(parseInt(discount)+parseInt(partial_paid_amount)+parseInt(advance_paid)),
												"current_paid_amount" : -partial_paid_amount,
												"balance_amt"         : -(parseInt(amount)+parseInt(delivery_charges)-parseInt(discount)-parseInt(partial_paid_amount)-parseInt(advance_paid)),
									 ...
									 if (confirm("Do You Wish To Print Invoice!")) {
										  ...
										  //var url = "receipt.jsp";
									 		...
									 		var url = "purchase_order_booking_receipt.jsp" + '?vendors_code=' + vendors_code + '&order_code=' + order_code + '&partial_paid_amount=' + partial_paid_amount  ;
