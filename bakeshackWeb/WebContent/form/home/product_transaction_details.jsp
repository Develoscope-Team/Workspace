...
<body id="kt_body"
	...
	<div class="card card-custom gutter-b ">
		...
		<font size="+2"><u><center>Name: <span class=" " id="finish"></span></center></u></font><br />
			<table class="table" style="border: 1px solid black">
				<thead>
					<tr>
						...
						<th style="text-align: center" scope="col">Field </th>
						<th style="text-align: center" scope="col"> Opening Qty</th>
						<th style="text-align: center" scope="col">Purchase Qty</th>
						<th style="text-align: center" scope="col">Used Qty </th>
						<th style="text-align: center" scope="col">Sale Qty</th>
						<th style="text-align: center" scope="col">Out Qty</th>
						<th style="text-align: center" scope="col">Produced Qty</th>
					</tr>
				</thead>
...
<script type="text/javascript"	src="<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/BakeShack_IM/js/main.js"></script>
	...
	const product_code = urlParams.get('pcode');
	product_name = urlParams.get('query');
	var html;
	 $('#finish').text(product_name);
	$.ajax({
		url : base + "/bakeshackAPI/api/getProductTransactionDetails",
		type : "post",
		dataType : "json",
		async : false,
		data : {
