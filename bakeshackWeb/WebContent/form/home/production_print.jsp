						...
						<!--begin::Container-->
							<div class="container mt-10" style="font-size: 16px;">
								...
								<div class="card card-custom overflow-hidden">
									...
									<!-- end: Invoice header-->
									<!-- begin: Invoice body-->
									<div class="row justify-content-center py-8 px-8 py-md-10 px-md-0 ml-3">
										<div class="col-md-10">
										<h2	class=" text-black font-weight-bolder  text-center mb-5 " style="font-size: 18px;"><u> Raw Material List</u></h2>
									...
									<div class="modal" id="bankModel" tabindex="-1"
										...
										<div class="row col-md-10 justify-content-center offset-1 mt-10 mb-10">
										<div class="col-md-6 offset-3" id="print_button" >
											<button type="button"
												class="btn-print btn-primary font-weight-bold" id="print_button1">Print Invoice</button>
										</div>
									</div>
									</div>
								</div>
