						...
						<div
							...
							<div class="d-flex align-items-center flex-wrap mr-1">
								...
								<div class="d-flex flex-column">
									<!--begin::Title-->
									<h2 class="text-white font-weight-bold my-2 mr-5">Purchase Order Booking</h2>
    ...
    <label>
     ...
     <span></span>
									...
									<div class="form-group" id="amount_div1">
										<label>Advance Paid Amount</label> <span class="text-danger" id="type">*</span><input type="number"
					...
					success:function(data)
			 	{
						...
						data.forEach((row)=> {
							...
							if(row.vendors_code == ccode && row.balance_amount > 0)
							 ...
							 /* alert(Grand_Total); */
								   $('#invoiceId-' + k).val(row.invoice_code);
										...
										success : function(response) {
											if (response != null) {
												...
												if (response >= 1) {
													...
													var msg = "Purchase Order Data inserted Successfully.";
													 $('#success_msg').text(msg);
													 $('#success_alert').addClass("show");
											           $('#success_alert').removeClass("hide");
											           $('#success_alert').addClass("showAlert");
