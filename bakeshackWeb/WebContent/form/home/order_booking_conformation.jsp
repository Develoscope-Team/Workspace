						...
						<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
							...
							<div class="d-flex align-items-center flex-wrap mr-1">
								...
								<div class="d-flex flex-column">
									<!--begin::Title-->
									<h2 class="text-white font-weight-bold my-2 mr-5">Sales & Order Entry</h2>
									<!--end::Title-->
								</div>
								<!--end::Heading-->
							</div>
																...
																<div class="col-lg-6">
																	<div class="form-group" id="credit_div">
																		<label>Credit Period</label> <input type="text"
																			class="form-control form-control-solid"	id="credit_period"> </input>
																	</div>
																</div>
																<div class="col-lg-6">
																	<div class="form-group" id="credit_div">
																		<label>Credit Period End Date</label> <input
																			type="text" class="form-control form-control-solid" id="credit_period_end_date"> </input>
																	</div>
																</div>
															</div>
															<div class="row">
...
$('#add_sales_order').click(function() {
								...
								var jsonString = JSON.stringify(productList);	
									   $.ajax({
										url : base + "/bakeshackAPI/api/insertUpdateSalesAndOrderDetailsFromDelivery",
										type : "post",
										dataType : "json",
										async : false,
										data : {
											...
											"partial_paid_amount" : parseInt(advance_amount) + parseInt(partial_paid_amount),
											"balance_amount" : parseInt(amount)-parseInt(discount) - parseInt(partial_paid_amount)-parseInt(advance_amount) + parseInt(delivery_charges),
								  ...
								  var transaction_id;
									  ...
									  $.ajax({
											...
											data : {
												...
												"paid_amount"         : parseInt(advance_amount)+parseInt(partial_paid_amount ),
												"current_paid_amount" : partial_paid_amount,
												"payment_mode"        : payment_mode,
												"balance_amt"         : parseInt(amount) - parseInt(discount) - parseInt(partial_paid_amount )- parseInt(advance_amount),
									  ...
									  $.ajax({
											...
											data : {
												...
												"total_amount" : total_amount,
												"partial_paid_amount" : parseInt(advance_amount)+parseInt(partial_paid_amount ),
												"balance_amount" :  parseInt(amount) - parseInt(discount) - parseInt(partial_paid_amount )- parseInt(advance_amount),
												"received_bank" : received_bank,
												"account_no" : account_no,
												"cancelation_date" :"",
	...
	$(this).closest('tr').remove();	
			...
			function weightConverter(k,valNum) {
				 ...
				 for(var j = 1 ;j<=i ;j++)
				 {
					 ...
					 calculate_total += parseInt(calculate_unit_total);
					 document.getElementById('amount').value = calculate_total;
					 document.getElementById('total_amount').value = parseInt(calculate_total) - parseInt($("#discount").val()) + parseInt($("#delivery_charges").val());
					 document.getElementById('partially_paid_amount').value = parseInt(calculate_total) -parseInt($("#discount").val())-parseInt($("#advance_paid").val()) + parseInt($("#delivery_charges").val());
					 }
				 }
          }
