...
<body id="kt_body"
	style="background-image: url(<%=VO_Face.getContainerDeployPath()%>/ResourceBundles/Resources/assets/BakeShack_IM/BakeShack_IM/gif/BakeShack003.jpg)"
	...
	<div id="kt_header_mobile" class="header-mobile">
		...
		<div class="d-flex align-items-center">
			...
			<button class="btn btn-icon btn-hover-transparent-white p-0 ml-3"
				...
				<span class="svg-icon svg-icon-xl"> <!--begin::Svg Icon | path:assets/BakeShack_IM/BakeShack_IM/media/svg/icons/General/User.svg-->
