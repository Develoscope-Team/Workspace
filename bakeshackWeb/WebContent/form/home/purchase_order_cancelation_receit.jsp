								...
								<div class="card-body p-0">
									...
									<div
										...
										<img alt="Logo"
											...
											<h1
												class=" text-black font-weight-boldest mt-35  mb-20  text-center ml-25 "><u>PURCHASE CANCELLATION RECIEPT</u>
												 </h1>
									...
									<div class="row col-12  ">
										<div class=" text-center col-md-10 offset-1" id="print_button">
