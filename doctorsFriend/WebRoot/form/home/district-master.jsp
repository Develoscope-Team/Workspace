				...
				<div class="content d-flex flex-column flex-column-fluid"
					...
					<div class="d-flex flex-column-fluid">
						...
						<div class="container offset-3">
							...
							<h2
								class="d-flex align-items-center text-dark font-weight-bold my-1 mr-3">District
								Master</h2>
														...
														<form class="form" id="kt_form_1">
															<div class="card-body">
																<div class="form-group">
																	<label>District Name</label><span class="text-danger"
																		id="type">*</span> <input type="text" name="district"
																		id="district" class="form-control form-control-solid"
																		placeholder="Enter District" required /> <span
																		class="msg text-danger" id="type1"> </span>
																</div>
															</div>
															<div class="text-center">
																<button type="submit" id="addDistrict"
																	class="btn btn-primary mr-2">Submit</button>
																<button type="submit" id="updateDistrict"
							...
							<br />
							<div class="card card-custom gutter-b" style="width: 66%">
									...
									<table data-toggle="table" class='a'
										...
										<thead>
											<tr>
												...
												<th class="col-sm-1 text-center" data-field="district"
													data-sortable="true">District Name</th>
		...
		$('#addDistrict')
				.click(
						function() {
							...
							var flag = 1; // Addition
							var letters = /^[A-Za-z() .]+$/;
							if(district != ''  && district.match(letters)){
								$.ajax({
									url : base + "/dssAPI/dfapi/insertUpdateDistrict",
									type : "post",
									dataType : "json",
									async : false,
									data : {
									...
									success : function(response) {
										if (response != null) {
											...
											if (response == 1) {
												...
												var msg = "District Data inserted Successfully.";
												alert(msg);
...
$.ajax({
	url : "http://localhost:8080/dssAPI/dfapi/getDistrictDetails",
	type : "post",
	dataType : "json",
	async : false,
		...
		function update(id){
			...
			$.ajax({
		        ...
		        success:function(data)
		        {
		            ...
		            const row = data.find(d => d.district_id ==id);
		           
		            $("#district").val(row.district_name);
								...
								success : function(response) {
									if (response != null) {
										...
										if (response >= 1) {
											...
											var msg = "District Data Updated Successfully.";
											alert(msg);
	...
	"use strict";
		...
		function deleteById(id){
			...
			$.ajax({
				...
				error : function(xhr) {
					var msg = "(Data deletion field.Error : "
							+ xhr.status
							+ " "
							+ xhr.statusText;
					alert(msg);
				...
				success : function(response) {
					if (response != null) {
						...
						if (response >=1) {
							...
							var msg = "District Data deleted Successfully.";
							alert(msg);
