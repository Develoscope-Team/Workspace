															...
															<div
																...
																<div class="card-body p-0">
																	...
																	<ul
																		...
																		role="tablist" style="background-color: transparent;">
																		<!--begin::Item-->
																		<li
																		...
																		<li
																			...
																			data-toggle="pill" href="#tab_forms_widget_3"> <span
																				class="nav-text font-size-lg py-2 font-weight-bold text-center"
																				id="new_reg"></span> <span
																				class="nav-icon py-2 w-auto"> <span
																					class="svg-icon svg-icon-3x"> <!--begin::Svg Icon | path:assets/media/svg/icons/Media/Movie-Lane2.svg-->
																						<svg xmlns="http://www.w3.org/2000/svg"
																							xmlns:xlink="http://www.w3.org/1999/xlink"
																							width="24px" height="24px" viewBox="0 0 24 24"
																							version="1.1">
																	...
																	<div
																		...
																		<div
																			...
																			<div class="p-1 flex-grow-1">
																				...
																				<h6 class="font-weight-bold">
																					<a href="prescriptionPrint.jsp">Prescription
																						Print</a>
																				</h6>
																				<h6 class="font-weight-bold ">
			...
			success : function(data) {
				...
				if (row != null) {
					...
					if (row.daily_collection != null) {
						$('#todays_collection').text(
								row.daily_collection + ' RS');
					} else {
