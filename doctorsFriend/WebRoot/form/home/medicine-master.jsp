												...
												<form class="form" id="kt_form_1">
													<div class="card-body">
														<div class="col-xl-8 offset-xl-2">
															...
															<div class="form-group">
																<label>Medicine Category</label><span
															...
															<div class="form-group">
																<label>MR Name</label> <input type="text"
																	class="form-control form-control-solid" name="mrName" n
													...
													<thead>
														<tr>
															...
															<th class="col-sm-3 text-center"
																data-field="Medicine_Name" data-sortable="true">Medicine
																Name</th>
															<th class="col-sm-3 text-center"
																data-field="Medicine_Type" data-sortable="true">Medicine
																Type</th>
															<th class="col-sm-3 text-center"
...
$("#addMedicineDetail").show();
	$('#addMedicineDetail').click(function() {
						...
						$.ajax({
									...
									success : function(response) {
										if (response != null) {
											var msg = "Medicine Data inserted Failed.";
...
function update(id){
	...
	$('#updateMedicineDetail').click(function() {
				var medicineName = $('#medicineName').val();
				var medicineType = $('#medicineType').val();
				var medicineCategory = $('#medicineCategory').val();
				var mgfName = $('#mgfName').val();
