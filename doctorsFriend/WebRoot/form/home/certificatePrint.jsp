										...
										<div class="col-md-10 offset-1">
											...
											<div id="fit">
												<div class="content font-size-h3">
													<p style="font-size: 30px" class="">
														This is to certify that <span style="font-weight: bold"
															class="setPatient_name"> </span> age <span
															style="font-weight: bold" class="setAge"> </span>
														residence <span style="font-weight: bold"
															class="setResidence"> </span> was under my treatment as
														an OPD patient from Date <span class="setDate"> </span>.
													</p>
													<p style="font-size: 30px" class="my-5">
														He / She was suffering from <span class="setComplaint">
														</span> and was advised to take rest.
													</p>
												...
												<div class="content font-size-h3">
													<p style="font-size: 30px" class="">
														This is to certify that <span style="font-weight: bold"
															...
															style="font-weight: bold" class="setAge"> </span>
														residence <span style="font-weight: bold"
															class="setResidence"> </span> is under my treatment as an
														OPD patient from Date <span style="font-weight: bold"
															class="setDate"> </span>.
													</p>
													<p style="font-size: 30px" class="my-5">
														He / She is suffering from <span class="setComplaint">
														</span> and is advised to take rest.
													</p>
													<p style="font-size: 30px" id="setExtra_content2"></p>

													<p style="font-size: 30px" class="">
														He/She is advised to take rest for <span
															style="font-weight: bold" class="setRest_days"> </span>
											...
											<div id="ref_letter">
												<div class="content font-size-h3">
													...
													<p style="font-size: 30px" class="">
														Referring here with <span style="font-weight: bold"
															class="setPatient_name"> </span> complaining of <span
															style="font-weight: bold" class="setComplaint"> </span>,
														for your kind consultation, management and investigation.
													</p>
													<p style="font-size: 30px" id="setExtra_content"></p>
													<p style="font-size: 30px" class="mt-5">Please examine
														the patient and do the needful.</p>
												</div>
											</div>
											<div class="cert_footer text-right">
												<div class="col-md-10   mr-20 text-right"
