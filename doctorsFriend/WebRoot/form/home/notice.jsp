					...
					<div class="d-flex flex-column-fluid">
						...
						<div
							...
							<div class="col-xl-12 offset-xl-1">
								<h2	class="d-flex align-items-center text-dark font-weight-bold my-1 mr-3">Notice Master</h2>
												...
												<table data-toggle="table" class='a'
													...
													<thead>
														<tr>
															...
															<th class="col-sm-2 text-center" data-field="notice_name"
																data-sortable="true">Notice Name</th>
															<th class="col-sm-2 text-center" data-field="notice_desc"
																data-sortable="true">Notice Desc</th>
																<th class="col-sm-2 text-center" data-field="from_date"
																data-sortable="true">From Date</th>
															<th class="col-sm-2 text-center" data-field="till_date"
...
$(document).ready(function (){
 ...
 function update(id){
				...
				$.ajax({
			        ...
			        success:function(data)
			        {
			            const row = data.find(d => d.notice_id ==id);
			            $('#notice_name').val(row.notice_name);
			            $('#notice_desc').val(row.notice_desc);
					    $('#from_date').val(row.from_date);
						$('#till_date').val(row.till_date);
			        }
			     });
							...
							if (notice_name != "" && notice_desc != "") {
								...
								$.ajax({
											...
											success : function(response) {
												if (response != null) {
													if (response >= 1) {
														var msg = "Notice Data Updated Successfully.";
														$('#success_msg').text(msg);
														 $('#success_alert').addClass("show");
												           $('#success_alert').removeClass("hide");
												           $('#success_alert').addClass("showAlert");
