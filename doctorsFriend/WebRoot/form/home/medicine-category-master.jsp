...
<body id="kt_body"
					...
					<div class="d-flex flex-column-fluid">
						...
						<div class="container d-flex align-items-stretch justify-content-between">
							<div class="col-xl-12 offset-xl-1">
								<h2 class="d-flex align-items-center text-dark font-weight-bold my-1 mr-3">Medicine	Category Master</h2>
											...
											<div class="card card-custom">
												<form class="form" id="kt_form_1">
													<div class="card-body">
														<div class="col-xl-8 offset-xl-2">
															<div class="form-group">
																<label>Medicine Category Name</label><span
																	class="text-danger" id="type">*</span> <input
																	type="text" id="medicine_category_name"
													...
													<div class="text-center">
														<button type="submit" id="addMedicineCategory"
															class="btn btn-primary mr-2">Submit</button>
														<button type="submit" id="updateMedicineCategory"
													...
													<thead>
														<tr>
															...
															<th class="col-sm-3 text-center"
																data-field="medicine_category_name" data-sortable="true">Medicine
																Category Name</th>
	...
	var base='<%=base%>';  
	$("#medicine_category_name").change(function(){
		var text=	$("#medicine_category_name").val();
		var letters = /^[A-Za-z() .]+$/;
	...
	$('#updateMedicineCategory').hide();
	$("#addMedicineCategory").show();
		$('#addMedicineCategory').click(function() {
							var medicine_category_name = $('#medicine_category_name').val();
							var flag = 1; // Addition
							var letters = /^[A-Za-z() .]+$/;
						if(medicine_category_name != "" && medicine_category_name.match(letters)){
							$.ajax({
								url : base + "/dssAPI/dfapi/insertUpdateMedicineCategory",
								type : "post",
								dataType : "json",
								async : false,
								data : {
									"medicine_category_name" : medicine_category_name,
									"flag" : flag
								},
								error : function(xhr) {
								...
								success : function(response) {
									if (response != null) {
										var msg = "MedicineCategory Data inserted failed.";
										...
										if (response >= 1) {
											var msg = "MedicineCategory Data inserted Successfully.";
											$('#success_msg').text(msg);
											 $('#success_alert').addClass("show");
									           $('#success_alert').removeClass("hide");
									           $('#success_alert').addClass("showAlert");
		...
		"use strict";
		//Class definition	
var medicine_category_id;
var html = "";
$.ajax({
	url : "http://localhost:8080/dssAPI/dfapi/getMedicineCategory",
	type : "post",
	dataType : "json",
	async : false,
...
$(document).ready(function (){
	   var table = $('#table-id').DataTable();
		...
		function update(id){
			$(window).scrollTop(0);		
			$('#updateMedicineCategory').show();
			$("#addMedicineCategory").hide();
			$(".btn_advice").hide();
			$.ajax({
		        type:"POST",
		        dataType: "json",
		        ...
		        success:function(data)
		        {
		            const row = data.find(d => d.medicine_category_id ==id);
		            $("#medicine_category_name").val(row.medicine_category_name);
		        }
		     });
			$('#updateMedicineCategory').click(	function() {
						var medicine_category_name = $('#medicine_category_name').val();
						var flag = 2; // Addition
						if(medicine_category_name != ''){
							$.ajax({
								url : base + "/dssAPI/dfapi/insertUpdateMedicineCategory",
								type : "post",
								dataType : "json",
								...
								success : function(response) {
									if (response != null) {
										var msg = "Medicine Category Data Updated failed.";
										$('#success_msg').text(msg);
										 $('#success_alert').addClass("show");
								           $('#success_alert').removeClass("hide");
								           $('#success_alert').addClass("showAlert");
										...
										if (response >= 1) {
											...
											var msg = "Medicine Category Data Updated Successfully.";
											$('#success_msg').text(msg);
											 $('#success_alert').addClass("show");
									           $('#success_alert').removeClass("hide");
									           $('#success_alert').addClass("showAlert");
	...
	"use strict";
		...
		// Delete data by medicine_category_id
						...
						success : function(response) {
							if (response != null) {
								...
								if (response >=1) {
									...
									var msg = "Medicine Category Data deleted Successfully.";
									$('#danger_msg').text(msg);
