					...
					<div class="d-flex flex-column-fluid">
						...
						<div
							...
							<div class="col-xl-12 offset-xl-1">
								...
								<h2
									class="d-flex align-items-center text-dark font-weight-bold my-1 mr-3"  >Medicine Type
									Master</h2>
													...
													<form class="form" id="kt_form_1">
														...
														<div class="col-xl-8 offset-xl-2">
															<div class="form-group">
																	<label>Medicine Type Name</label><span
																		class="text-danger" id="type">*</span> <input
																		type="text" id="medicine_type_name"
																		class="form-control form-control-solid"
																		placeholder="Enter Medicine Type Name" required /> <span
														...
														<div class="text-center">
																<button type="submit" id="addMedicineType"
											...
											<thead>
												<tr>
													...
													<th class="col-sm-3 text-center"
														data-field="medicine_type_name" data-sortable="true">Medicine
														Type Name</th>
...
.alert-text {
	...
	$("#medicine_type_name").change(function(){
		var text=	$("#medicine_type_name").val();
		var letters = /^[A-Za-z() .]+$/;
		...
		$('#addMedicineType').click(function() {
							...
							var flag = 1; // Addition
							var letters = /^[A-Za-z() .]+$/;
						if(medicine_type_name != "" && medicine_type_name.match(letters)){
							$.ajax({
...
$.ajax({
	url : "http://localhost:8080/dssAPI/dfapi/getMedicineType",
	type : "post",
	dataType : "json",
	async : false,
		...
		function update(id){
			...
			$.ajax({
		        ...
		        success:function(data)
		        {
		            ...
		            $("#medicine_type_name").val(row.medicine_type_name);
