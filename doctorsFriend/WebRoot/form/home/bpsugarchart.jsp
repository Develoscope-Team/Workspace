					...
					<div class="d-flex flex-column-fluid">
						...
						<div
							...
							<div class="col-xl-12 offset-xl-1">
								<h2
									class="d-flex align-items-center text-dark font-weight-bold my-1 mr-3 ml-4">
									B.P. and Diabetes Chart</h2>
												...
												<form class="form" id="kt_form_1">
													...
													<div class="card card-custom gutter-b ">
														...
														<div class="card-body" id="card_Report">
															...
															<br /> <u><center>
																	<font size="+3">B.P </font> <font size="+2">(रक्तदाब )</font><font size="+3"> & Diabetes </font>
																	<font size="+2">(मधुमेह)</font><font size="+3"> Chart</font>
																</center></u> <br />
															<table class="table table-responsive"
																style="border: 1px solid black">
																<thead>
																	<tr>
																		<th style="text-align: center;" scope="col"><h4>No.</h4>
																			<h6>(क्रमांक)</h6></th>
																		<th style="text-align: center" scope="col"><h4>Date</h4>
																			<h6>(दिनांक)</h6></th>
																		<th style="text-align: center;" scope="col"><h4>Time</h4>
																			<h6>(वेळ)</h6></th>
																		<th style="text-align: center" scope="col"><h4>B.p</h4>
																			<h6>(रक्तदाब)</h6></th>
																		<th style="text-align: center" scope="col"><h4>Sugar</h4>
																			<h6>(मधुमेह)</h6></th>
																		<th style="text-align: center" scope="col"><h4>Medicine</h4>
																			<h6>(औषध)</h6></th>
																	</tr>
																</thead>
