...
<body id="kt_body"
					...
					<div class="d-flex flex-column-fluid">
						...
						<div class="container d-flex align-items-stretch justify-content-between">
							<div class="col-xl-12 offset-xl-1">
								<h2	class="d-flex align-items-center text-dark font-weight-bold my-1 mr-3">Complaint Master</h2>
													...
													<div class="card-body">
														<div class="col-xl-8 offset-xl-2">
															<div class="form-group">
																<label>Complaint Name</label><span class="text-danger"
																	id="type">*</span> <input type="text"
																	name="complaint_name" id="complaint_name"
																	class="form-control form-control-solid"
																	placeholder="Enter Complaint Name" required />
															</div>
															<div class="form-group">
																<label>Complaint Detail</label><span class="text-danger"
																	id="type">*</span>
																<textarea name="complaint_desc" id="complaint_desc"
													...
													<thead>
														<tr>
															...
															<th class="col-sm-3 text-center"
																data-field="complaint_name" data-sortable="true">Complaint
																Name</th>
															<th class="col-sm-3 text-center"
																data-field="complaint_desc" data-sortable="true">Complaint
																Detail</th>
	...
	$("#addComplaint").show();
		$('#addComplaint').click(function() {
							...
							var flag = 1; // Addition
						if(complaint_name != "" && complaint_desc != ""){
							$.ajax({
								url : base + "/dssAPI/dfapi/insertUpdateComplaint",
								type : "post",
								dataType : "json",
								async : false,
								data : {
        ...
        var html = "";
$.ajax({
	url : "http://localhost:8080/dssAPI/dfapi/getComplaints",
	type : "post",
	dataType : "json",
	async : false,
		...
		function update(complaint_id){
			...
			$.ajax({
		        ...
		        success:function(data)
		        {
		        	...
		        	$("#complaint_desc").val(row.complaint_desc);
		        }
		     });
