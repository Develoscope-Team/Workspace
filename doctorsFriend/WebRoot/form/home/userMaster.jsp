					...
					<div class="d-flex flex-column-fluid">
						...
						<div class="container d-flex align-items-stretch justify-content-between">
							<div class="col-xl-12 offset-xl-1">
								<h2	class="d-flex align-items-center text-dark font-weight-bold my-1 mr-3">User Master</h2>
								<div class="col-xl-10 offset-xl-0">
									...
									<div class="form-group col-md-6">
										<label>Login ID</label><span class="text-danger">*</span> <input
											type="text" class="form-control form-control-solid"
											name="login_id" id="login_id" placeholder="Enter Login ID"
											pattern="(?=.*[a-z])(?=.*[A-Z]).{8,}"
											title="Must Contain uppercase and Lowercase letter" required />
									...
									<div class="form-group col-md-6">
										<label> Confirm Password</label> <span class="text-danger">*</span> <span id='message1'></span><input
											type="confirm_password" class="form-control form-control-solid"
									...
									<div class="form-group col-md-6">
										...
										<select
											class="form-control form-control-solid" name="qualification"
									...
									<div class="form-group col-md-6">
										<label>Email</label> <input type="email"
											...
											<span class="msg text-danger" id="type11"> </span>
									</div>
									</div>
														</div>
													</div>
													...
													<thead>
														<tr>
															...
															<th class="col-sm-2 text-center" data-field="user_name"
																...
																<th class="col-sm-2 text-center" data-field="user_role"
																data-sortable="true">Role</th>
															<th class="col-sm-2 text-center" data-field="user_login_id"
