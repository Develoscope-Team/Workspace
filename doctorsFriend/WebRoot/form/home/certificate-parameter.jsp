					...
					<div class="d-flex flex-column-fluid">
						...
						<div class="container d-flex align-items-stretch justify-content-between">
							<div class="col-xl-12 offset-xl-1">
								<h2	class="d-flex align-items-center text-dark font-weight-bold my-1 mr-3 ml-4">Certificate Parameter</h2>
								<div class="col-xl-10 ">
									<div class="example mb-10">
										<div class="example-preview">
											<div class="card card-custom">
												<form method="get" action="certificatePrint.jsp"
													class="form" id="kt_form_1">
													<div class="card-body">
														<div class="form-group">
															<label>Select Certificate</label><span
																class="text-danger">*</span> <select
																class="form-control form-control-solid" name="cert_code" id="cert_code">
														...
														<div id="cert_form">
															<div class="form-group">
																...
																<input type="text" name="patient_code" id="patient_code"
																	...
																	placeholder="Enter Patient name" /> <span
															...
															<div id="in_ref">
																<div class="form-group">
																	<label>Ref. Doctor Name</label><span
																		...
																		class="form-control form-control-solid"
																		placeholder="Enter Dr name" /> <span
																		class="msg text-danger" id="type2"> </span>
																</div>

																<div class="form-group">
																	<label>Extra Content</label> <input type="text"
																		name="extra_content" id="extra_content"
																		maxlength="200" class="form-control" row="5" />
																	<h6>
																		<span class="msg text-info" id="type4">Enter
																			Maximum 200 letters in Input Box </span>
																	</h6>
																</div>
															</div>
															<div id="not_in_ref">
																...
																<div class="form-group">
																	<label class="rest_label">Date/Days</label><span
																		class="text-danger">*</span> <input type='number'
																		class="form-control" name="rest_days" id="rest_days"
																		placeholder="Enter Rest Days" /> <input type='date'
																		class="form-control form-control-solid form-control-lg"
																		name="rest_date" id="rest_date"
															...
															<div class="form-group">
																<input type="text"
																	class="form-control form-control-solid form-control-lg"
																	name="complaint_desc" id="complaint_desc" />
															</div>
															<div class="form-group" id="extra1">
																<label>Extra Content</label> <input type="text"
																	name="extra_content1" id="extra_content"
																	maxlength="200" class="form-control" row="5" />
																<h6><span class="msg text-info" id="type4">Enter
																		Maximum 200 letters in Input box </span></h6>
															</div>
														</div>
													</div>
													<div class="text-center">
														<button type="submit"
															class="btn btn-primary font-weight-bold" id="print">Print
															Certificate</button>
													</div>
												</form>
												<!--end::Form-->
