					...
					<div class="d-flex flex-column-fluid">
						...
						<div class="container">
							<div class="col-xl-12 offset-xl-1">
								<h2	class="d-flex align-items-center text-dark font-weight-bold my-1 mr-3">Patient Detail Entry</h2>
								<div class="col-xl-11 offset-xl-0.5">
																...
																<div class="offset-xxl-2 col-xxl-8">
																	<form class="form" id="kt_form">
																		...
																		<div class="pb-5" data-wizard-type="step-content"
																			...
																			<div class="mb-10 d-flex justify-content-between">
																				...
																				<button type="button" class="btn btn-primary"
																					...
																					data-target="#patientHistory">Patient
																					History</button>
																			...
																			<div class="row">
																				...
																				<div class="col-xl-6">
																					<div class="form-group">
																						...
																						<input type="text"
																							class="form-control form-control-solid form-control-lg"
																							placeholder="YYYY year MM month" name="age"
																							id="age" />
																			...
																			<div class="col-xl-6">
																				<div class="form-group">
																					<label hidden>Aadhar No</label> <input
																						type="number"
																						class="form-control form-control-solid form-control-lg"
																		...
																		<div class="pb-5" data-wizard-type="step-content">
																			...
																			<div class="form-group">
																				<label>Complaints</label><select
																					name="complaints_name" id="complaints_name"
																		...
																		<div class="pb-5" data-wizard-type="step-content">
																			...
																			<div class="row">
																				...
																				<button type="button" id="injectionHistory"
																					class="btn btn-primary col-2 ml-5"
																					id="injectionHistory" data-toggle="modal"
																							...
																							<table class="table">
																								<thead>
																									<tr>
																										...
																										<th style="text-align: center;" scope="col">Visit
																											Date</th>
																										<th style="text-align: center" scope="col">Injection
																											Details</th>
																			...
																			<div class="text-right mb-5 mr-22">
																				...
																				<button type="button" class="btn btn-primary"
																					...
																					data-target="#createTemplate">Create
																					Template</button>
																						...
																						<div class="modal-content">
																							...
																							<div class="modal-body">
																								<div class="card-body">
																									...
																									<div class="form-group">
																										<label class="text-left">Template Name</label><span
																									...
																									<div class="form-group">
																										<label>Template Desc</label><span
																											class="text-danger">*</span> <input
																											type="text"
																											class="form-control form-control-solid"
																									...
																									<button type="button" id="addMedicineMaster"
																										class="btn font-weight-bold btn-primary mr-2 text-right">Create
																										template</button>
																								</div>
																							</div>
																						</div>
																			...
																			<div class="modal fade" id="medicineModel"
																				tabindex="-1" role="dialog"
																				aria-labelledby="staticBackdrop" aria-hidden="true">
																				<div
																					class="modal-dialog  modal-xl modal-dialog-scrollable"
																				...
																				<div class="col-9 col-form-label">
																					<div class="checkbox-list">
																						...
																						<div class="row">
																							...
																							<div class="col-md-4">
																								<label class="checkbox checkbox-lg"> <input
																									type="checkbox" id="isHeightWeight" checked />
																									<span></span> Height/Weight
																								</label> <label class="checkbox checkbox-lg"> <input
...
$.ajax({
		...
		success:function(data)
        {
			const row = data.find(d => d.patient_code == query);
			console.log(row);
			if(row != null){
				$('#kco').val(row.kco);
				$('#allergy').val(row.allergy);
		 	 ...
		 	 function nextPage(i){
		 		 ...
		 		 $.ajax({
				 		...
				 		success:function(data)
				 		{
				 			...
				 			$('#cTbl')
				 					.append('<tr class="font-weight-bolder h6"><td class="pt-7 px-5">'
				 									+ row.complaint_desc
				 									+ '</td><td class="pt-7">'
				 									+ row.diagnosis_desc
				 									+ '</td></tr>');
				 	        ...
				 	        parsedData.forEach(function(m, i) {
				 	        	if(m.is_special == 'Y')
				 	        		{
				 	        		$('#mTbl').append('<tr class="font-weight-boldest h6 text-success"><td class="pt-7 px-5"><div>'
				 									+ m.type
				 			...
				 			$('#mTbl').append('<tr class="font-weight-boldest h6 text"><td class="pt-7 px-5"><div>'
				 												+ m.type
				 												+ '</div></td><td class="pt-7">'
				 												+ m.medicineName
				 												+ '</div></td><td class="pt-7">'
