...
<body onafterprint="printP()" id="kt_body"
					...
					<div class="card-body p-0">
						...
						<div class="row justify-content-center pt-3 px-3 pt-md-5 px-md-0">
							...
							<div class="col-md-10 offset-1">
											...
											<div class="row">
											<h3 class="ml-3">Other Complaints :</h3><h3 class="ml-3" id="other_complaints"></h3>
											</div>
												...
												<!-- <div class="table-responsive">
													<table class="a">
														<thead>
															<tr>
																<th
																	class="font-weight-bold h3 text-muted text-uppercase pl-5"
																	id="complaints_name" style="overflow: hidden;">Complaints: </th>
																	<th id="complaints_desc"></th>
																	</tr>
																	<tr>
																<th
																	class=" col-5 font-weight-bold h3 text-muted text-uppercase pl-10"
																	id="diagnosis_name" style="overflow: hidden;">Diagnosis :</th>
																	<th id="diagnosis_desc"></th>
															</tr>
															
														</thead>
														<tbody id="cTbl" style="font-size: 18px;"
													style="scrollY: false; scrollX: false;">
 ...
 -->											</div>
							...
							<br />
											...
											<table class="a">
												<thead>
													<tr>
														<th
															class="font-weight-bold h3 text-muted text-uppercase pl-5"
															id="complaints_name" style="overflow: hidden;">Complaints:
														</th>
														<th
															class="font-weight-bold h3 text-muted text-uppercase pl-10"
															id="diagnosis_name" style="overflow: hidden;">Diagnosis
															:</th>
													</tr>
								...
								<div class="row  pb-10  px-md-1 offset-1" > 
												...
												<thead>
													<tr >
														<th
															...
															style="font-size: 18px; border-bottom: 1px solid black; border-right: 1px solid black;" >type</th>
														<th
															class="pt-1 pb-9 pl-0 font-weight-bolder text-muted font-size-lg text-uppercase text-center"
															style="font-size: 18px; border-bottom: 1px solid black; border-right: 1px solid black;">Med. Name</th>
														<th
															class="pt-1 pb-9  font-weight-bolder text-muted font-size-lg text-uppercase text-center"
															style="font-size: 18px; border-bottom: 1px solid black; border-right: 1px solid black;">Dose</th>
														<th
															class="pt-1 pb-9  font-weight-bolder text-muted font-size-lg text-uppercase text-center"
															style="font-size: 18px; border-bottom: 1px solid black; border-right: 1px solid black;">Times</th>
														<th
									...
									<div class="col-md-3  text-right" style="border-left: 1px solid black;">
										...
										<div id="vital">
											...
											<div
												class="d-flex h3 align-items-baseline justify-content-between">
												<p class="w-50 font-weight-bol d" id="blood_sugar_name_r"></p>
									...
									<div class="col-md-10 text-right ml-2" style="font-size: 25px">
										<img id="logo" alt="Logo"
											...
											if (m.is_special == 'Y') {
												...
												.append(
														'<tr class="font-weight-boldest  text-danger" style="font-size: 18px;"><td class="pt-7 px-5 " style="border-bottom: 1px solid black;"><div>'
																...
																+ '</td><td class=" pt-7 text-center" style="border-bottom: 1px solid black;">'
																+ m.qty
																+ '</td></tr><tr class="text-danger " style="font-size: 18px;"><td class=" pt-7 text-center" colspan="6" style="border-bottom: 1px solid black;">'
																+ m.remark
																+ '</td></tr>');
									} else {
										...
										$('#mTbl')
												.append(
														'<tr class="font-weight-boldest  text" style="font-size: 18px;"><td class=" pt-7 px-5" style="border-bottom: 1px solid black;"><div>'
																...
																+ '</td><td class="pt-7 text-center" style="border-bottom: 1px solid black;">'
																+ m.qty
																+ '</td></tr><tr style="font-size: 18px;"><td class=" pt-7 text-center" colspan="6" style="border-bottom: 1px solid black;">'
																+ m.remark
																+ '</td></tr>');
									}
								} else {
