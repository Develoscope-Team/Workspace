					...
					<div class="d-flex flex-column-fluid">
						...
						<div class="container d-flex align-items-stretch justify-content-between">
							<div class="col-xl-12 offset-xl-1">
								<h2	class="d-flex align-items-center text-dark font-weight-bold my-1 mr-3">Advice Master</h2>
													...
													<div class="card-body">
														<div class="col-xl-8 offset-xl-2">
															<div class="form-group">
																<label>Advice Name</label><span class="text-danger"
																	id="type">*</span><input type="text" name="advice_name"
																	id="advice_name"
																	class="form-control form-control-solid"
																	placeholder="Enter Advice Name" />
															</div>
															<div class="form-group">
																<label>Advice Detail</label>
																<textarea name="advice_desc" id="advice_desc"
																	class="form-control form-control-solid" rows="5"></textarea>
															</div>
														</div>
													</div>
													<div class="text-center">
														<button type="submit" id="addAdvice"
															class="btn btn-primary mr-2">Submit</button>
														<button type="submit" id="updateAdvice"
												...
												<table data-toggle="table" class='a'
													...
													<thead>
														<tr>
															...
															<th class="col-sm-2 text-center" data-field="advice_name"
																data-sortable="true">Advice Name</th>
															<th class="col-sm-2 text-center" data-field="advice_desc"
																data-sortable="true">Advice Detail</th>
	...
	$("#addAdvice").show();
		$('#addAdvice').click(function() {
						...
						if(advice_name != "" && advice_desc != ""){
							$.ajax({
								url : base + "/dssAPI/dfapi/insertUpdateAdvice",
								type : "post",
								dataType : "json",
								async : false,
								data : {
...
var html = "";
$.ajax({
	url : "http://localhost:8080/dssAPI/dfapi/getAdvice",
	type : "post",
	dataType : "json",
	async : false,
