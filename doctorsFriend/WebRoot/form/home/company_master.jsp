...
<body id="kt_body"
				...
				<div class="content d-flex flex-column flex-column-fluid"
					...
					<div class="d-flex flex-column-fluid">
						...
						<div class="container-fluid offset-4">
							...
							<h2
								class="d-flex align-items-center text-dark font-weight-bold my-1  ">Company
								Master</h2>
														...
														<form class="form" id="kt_form_1">
															<div class="card-body">
																<div class="form-group">
																	<label>Company Name</label><span class="text-danger"
																		id="type">*</span> <input type="text" name="company"
																		id="company" class="form-control form-control-solid"
																		placeholder="Enter Company" required /> <span
															...
															<div class="text-center">
																...
																<button type="submit" id="updatecompany"
												...
												class="svg-icon svg-icon-lg"> <!--begin::Svg Icon | path:assets/media/svg/icons/General/Search.svg-->
													<svg xmlns="http://www.w3.org/2000/svg"
														...
														height="24px" viewBox="0 0 24 24" version="1.1">
															...
															fill="#000000" fill-rule="nonzero" opacompany="0.3" />
																<path
									...
									<table data-toggle="table" class='a'
										...
										<thead>
											<tr>
												...
												<th class="col-sm-4 text-center" data-field="company"
	...
	$("#addCompany").show();
		...
		$('#addCompany').click(function() {
							...
							var flag = 1; // Addition
							var letters = /^[A-Za-z() .]+$/;
						if(company != "" && company.match(letters)){
							$.ajax({
								url : base + "/dssAPI/dfapi/insertUpdateCompany",
								type : "post",
								dataType : "json",
								async : false,
								data : {
								...
								success : function(response) {
									if (response != null) {
										...
										if (response >= 1) {
											...
											var msg = "company Data inserted Successfully.";
											alert(msg);
...
$.ajax({
	url : "http://localhost:8080/dssAPI/dfapi/getCompanyDetails",
	type : "post",
	dataType : "json",
	async : false,
	...
	success:function(data)
	{
		...
		const row = data.find(d => d.company_id == company_id);
		data.forEach((row)=> {
			...
			html += "<td>"+row.company_id+"</td>"; 
			 html += "<td>"+row.company_name+"</td>";
     	       	 ...
     	       	 html += '<td><a href="javascript:update('+row.company_id+');" class="btn_advice btn-sm btn-clean btn-icon mr-2" title="Edit details"><span class="svg-icon svg-icon-md"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="20px" height="20px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><rect x="0" y="0" width="20" height="20"/><path d="M8,17.9148182 L8,5.96685884 C8,5.56391781 8.16211443,5.17792052 8.44982609,4.89581508 L10.965708,2.42895648 C11.5426798,1.86322723 12.4640974,1.85620921 13.0496196,2.41308426 L15.5337377,4.77566479 C15.8314604,5.0588212 16,5.45170806 16,5.86258077 L16,17.9148182 C16,18.7432453 15.3284271,19.4148182 14.5,19.4148182 L9.5,19.4148182 C8.67157288,19.4148182 8,18.7432453 8,17.9148182 Z" fill="#B5B5C3" fill-rule="nonzero" transform="translate(12.000000, 10.707409) rotate(-135.000000) translate(-12.000000, -10.707409) "/><rect fill="#000000" opacompany="0.3" x="5" y="20" width="12" height="2" rx="1"/></g></svg></span>'
         

     	       	+ '<a href="javascript:deleteById('+row.company_id+');" class="btn_advice btn-sm btn-clean btn-icon" title="Delete"><span class="svg-icon svg-icon-md"> <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="20px" height="20px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><rect x="0" y="0" width="20" height="20"/><path d="M6,8 L6,20.5 C6,21.3284271 6.67157288,22 7.5,22 L16.5,22 C17.3284271,22 18,21.3284271 18,20.5 L18,8 L6,8 Z" fill="#B5B5C3" fill-rule="nonzero"/>\ <path d="M14,4.5 L14,4 C14,3.44771525 13.5522847,3 13,3 L11,3 C10.4477153,3 10,3.44771525 10,4 L10,4.5 L5.5,4.5 C5.22385763,4.5 5,4.72385763 5,5 L5,5.5 C5,5.77614237 5.22385763,6 5.5,6 L18.5,6 C18.7761424,6 19,5.77614237 19,5.5 L19,5 C19,4.72385763 18.7761424,4.5 18.5,4.5 L14,4.5 Z" fill="#000000" opacompany="0.3"/></g> </svg></span></a></td>';
	            html +="</tr>"
...
function update(id){
	...
	$.ajax({
        ...
        success:function(data)
        {
            ...
            const row = data.find(d => d.company_id ==id);
							...
							success : function(response) {
								if (response != null) {
									...
									if (response >= 1) {
										...
										var msg = "Company Data updated Successfully.";
										alert(msg);
				...
				success : function(response) {
					if (response != null) {
						...
						if (response >=1) {
							...
							var msg = "Company Data deleted Successfully.";
							alert(msg);
